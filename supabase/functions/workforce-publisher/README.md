...
- Required Haven segment/repository/CI/hosted gates remain separate. On 2026-09-24, main `855fd9f3` already contains the unchanged migration 496, native source probe and frozen wire contract through the concurrent Workforce release. This publisher runtime integrates that base without copying or reapplying the migration. Exact hosted migration/function readback and controlled activation remain separate release steps.
