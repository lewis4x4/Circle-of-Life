...
INSERT INTO auth.users(id,email,raw_app_meta_data,raw_user_meta_data)
 ...
 UNION ALL SELECT nurse,nurse||'@source.invalid',jsonb_build_object('organization_id',org,'app_role','med_tech'),'{"full_name":"Nurse"}'::jsonb FROM cf
...
INSERT INTO public.user_profiles(id,email,full_name,app_role,organization_id,is_active)
 ...
 UNION ALL SELECT nurse,nurse||'@source.invalid','Nurse','med_tech'::public.app_role,org,true FROM cf
