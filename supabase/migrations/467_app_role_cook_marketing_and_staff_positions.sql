...
-- inside a transaction cannot be used until that transaction commits, and 468
-- casts to it throughout.
--
-- app_role: 'housekeeper' already exists (routed to the caregiver app). 'cook' and
-- 'marketing' are new; 468 folds dietary and dietary_aide into cook and grants marketing.
