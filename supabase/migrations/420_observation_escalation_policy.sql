...
--
-- The structure mirrors the cadence configuration in migration 417 statement
...
-- from migration 419 is the single definition, reading its divisor and bounds
...
-- The grace rule already exists exactly once, in migration 419. This is a
