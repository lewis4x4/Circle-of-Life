"""Generate migration 468 (role consolidation) from a full local replay.
...
Usage: point /tmp/loc-psql.sh at a replay that has every migration through 467
applied, then: python3 scripts/role-sweep/generate-nurse-to-med-tech.py > supabase/migrations/468_role_consolidation.sql
"""
import re
import subprocess
import sys
...
-- supabase/migrations through 467, checked against production before generation.
