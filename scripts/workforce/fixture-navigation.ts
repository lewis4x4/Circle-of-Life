export const usePathname = () => ({ today: "/admin/staffing", people: "/admin/staff", timecards: "/admin/timecards" }[new URLSearchParams(window.location.search).get("view") ?? "today"] ?? "/admin/staffing");
