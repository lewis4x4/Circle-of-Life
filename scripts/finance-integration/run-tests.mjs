...
const directories = { finance: ['src/lib/finance-integration', 'src/lib/finance/post-to-gl.test.ts', 'src/lib/finance/forecast.test.ts', 'src/lib/finance/resident-money.test.ts', 'src/lib/finance/format-cents.test.ts', 'src/lib/finance/journal-form-lines.test.ts', 'src/lib/billing/generate-monthly-invoices.test.ts', 'src/lib/billing/generate-monthly-source-guards.test.ts', 'src/lib/billing/generate-monthly-temporal-payers.test.ts', 'src/components/finance/CashTrustLedgersClient.test.tsx', 'src/app/(admin)/finance/journal-entries/new', 'src/components/finance/FinanceReviewQueueClient.test.tsx'], audit: ['src/lib/platform-audit'] };
