...
const directories = { finance: ['src/lib/finance-integration', 'src/lib/finance/post-to-gl.test.ts', 'src/lib/finance/forecast.test.ts', 'src/lib/finance/resident-money.test.ts', 'src/app/(admin)/admin/cash/page.test.tsx'], audit: ['src/lib/platform-audit'] };
