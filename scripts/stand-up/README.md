...
2. The upcoming Monday report opens at that facility's entry window, Sunday 12:00 a.m. Eastern unless an owner has widened or narrowed it under Management tools (COL-350); otherwise the current Monday is selected. Staffing covers the preceding Monday–Sunday. Save a draft, enter or confirm the sixteen fields, then mark Ready after the staffing period closes. Ready does not certify staffing verification. Blank means missing; enter 0 for a genuine zero.
