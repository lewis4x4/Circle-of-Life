...
const DASHBOARD_CONFIGS: Record<string, DashboardConfig> = {
  ...
  admin_assistant: {
    ...
    primaryTaskLanes: ["family_bulletin", "transportation", "referrals"],
    ...
    visibleItemKeys: ["site-work", "referrals", "admissions", "benefits", "family-portal", "residents", "transportation", "staff", "kb-admin", "document-intake", "front-desk"],
    sections: {
  ...
  coordinator: {
    ...
    primaryTaskLanes: ["care_plans", "assessments", "family_bulletin"],
    ...
    visibleItemKeys: ["admissions", "benefits", "family-portal", "residents", "care-plans", "assessments", "document-intake", "front-desk"],
    sections: {
      heroStats: true, quickActions: true, criticalUpdates: true,
