...
const DASHBOARD_CONFIGS: Record<string, DashboardConfig> = {
  ...
  admin_assistant: {
    ...
    visibleItemKeys: ["site-work", "referrals", "admissions", "benefits", "family-portal", "residents", "transportation", "staff", "kb-admin", "document-intake"],
    sections: {
  ...
  coordinator: {
    ...
    visibleItemKeys: ["admissions", "benefits", "family-portal", "residents", "care-plans", "assessments", "document-intake"],
    sections: {
      heroStats: true, quickActions: true, criticalUpdates: true,
