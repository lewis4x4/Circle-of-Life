/** Family-facing copy for the one-way staff bulletin on Today / Updates. */

export const FAMILY_HOME_BULLETIN_TITLE = "Care team bulletin";

export const FAMILY_HOME_BULLETIN_HELPER =
  "Staff post updates here — you cannot reply in Haven.";

export const FAMILY_HOME_BULLETIN_EMPTY_TITLE = "No notes posted yet";

export const FAMILY_HOME_BULLETIN_EMPTY_DESCRIPTION =
