...
export function hasComparableStandupDefinition(metric: QualityMetric, quality: StandupSourceQuality): boolean {
...
export function canCompareStandupMetrics(left: QualityMetric | null | undefined, right: QualityMetric | null | undefined): boolean {
  ...
  return hasComparableStandupDefinition(left, a) && hasComparableStandupDefinition(right, b)
