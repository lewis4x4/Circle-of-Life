/**
 * Hard-coded pale grey text utilities (text-{slate,zinc,stone,gray,neutral}
 * at 300/400/500) without a `dark:` prefix. On the light theme's cream canvas and cards they
 ...
 * `text-muted-foreground` (or `text-text-muted` in v2) instead; on a surface
 * that is dark in every theme, `text-chrome-foreground-muted` (COL-704).
 */
