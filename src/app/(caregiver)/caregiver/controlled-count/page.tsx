  ...
  return (
    <div className="space-y-4 pb-8">
      <div className="flex items-center justify-between gap-2">
        <div>
          <h1 className="text-xl font-semibold text-white">Controlled count</h1>
          <p className="text-xs text-zinc-400">Shift reconciliation for scheduled medications</p>
        </div>
                ...
                <CardContent>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      setLines((prev) =>
                        prev.map((x) => (x.med.id === line.med.id ? { ...x, actual: v } : x)),
                      );
                    }}
      ...
      <Link href="/caregiver/meds" className="block text-center text-sm text-teal-500 hover:underline">
        Back to Meds
      </Link>
