...
// Recruiter works reviews too (owner ruling 2026-09-22; migration 468 grants reputation_replies).
const GOOGLE_REPLY_ROLES = ["owner", "org_admin", "facility_admin", "med_tech", "recruiter"] as const;
