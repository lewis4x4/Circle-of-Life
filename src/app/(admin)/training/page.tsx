          ...
          <div className="h-[160px]">
            <V2Card hoverColor="indigo" className="border-primary/20 shadow-[inset_0_0_15px_rgba(99,102,241,0.05)]">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <p className="text-4xl font-mono tracking-tighter text-primary pb-1">{rows.length}</p>
              </div>
            </V2Card>
          </div>
                        ...
                        <div className="flex justify-between items-start mb-4">
                          ...
                          <span className="flex flex-col items-end gap-1 text-right sm:flex-row sm:items-center sm:gap-2">
                            {orgWideMode && row.facilities?.name ? (
                              <span className="text-[9px] text-primary font-mono font-bold bg-primary/10 px-2 py-0.5 rounded">
                                {row.facilities.name}
                              </span>
                            ) : null}
                      ...
                      {recentPassedRows.map((row) => {
                        ...
                        >
                          <div className="flex-1 min-w-0">
                            {orgWideMode && row.facilities?.name ? (
                              <p className="text-[9px] font-mono text-primary mb-0.5 truncate">
                                {row.facilities.name}
                              </p>
                            ) : null}
