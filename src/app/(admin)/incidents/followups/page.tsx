    ...
    <div className="space-y-6 animate-in fade-in duration-[var(--motion-duration)]">
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-semibold text-foreground">Incident Follow-ups</h1>
            <p className="text-sm text-muted-foreground">
              Work the full follow-up backlog across incidents, with urgency and ownership filters.
            </p>
          </div>
          <div className="flex items-center gap-2">
            <Badge variant="outline" className="border-border bg-muted text-muted-foreground">{counts.all} open</Badge>
            <Badge variant="outline" className="border-destructive/30 bg-destructive/10 text-destructive">{counts.overdue} overdue</Badge>
            <Badge variant="outline" className="border-warning/30 bg-warning/10 text-warning">{counts.escalated} escalated</Badge>
            <Badge variant="outline" className="border-warning/30 bg-warning/10 text-warning">{counts.unassigned} unassigned</Badge>
          </div>
        </div>
      </div>
