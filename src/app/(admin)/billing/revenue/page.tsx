        ...
        {!isLoading && byMonth.length > 0 ? (
          <div className="p-6 sm:p-8 rounded-lg border border-slate-200/60 dark:border-white/5 bg-slate-50/50 shadow-sm relative overflow-hidden transition-all">
            <div className="mb-6 border-b border-slate-200 dark:border-white/5 pb-4 flex items-center justify-between">
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mt-1">Monthly Breakdown</h3>
               ...
               <MotionList className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  {byMonth.map((r) => (
                    <MotionItem key={r.key}>
                      <div className="group flex flex-col justify-between p-6 h-full rounded-lg border border-slate-200/90 bg-white dark:border-white/5 shadow-sm transition-all hover:shadow-md hover:border-emerald-300 dark:hover:border-emerald-500/40">
                         ...
                         <div className="flex items-end justify-between w-full mt-auto">
                            <div className="flex flex-col">
                               <span className="font-bold uppercase tracking-wider text-[10px] text-slate-400 mb-1">Volume</span>
                            ...
                            <div className="flex flex-col items-end">
                               <span className="font-bold uppercase tracking-wider text-[10px] text-slate-400 mb-1">Received</span>
