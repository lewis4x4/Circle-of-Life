  ...
  return (
    <div className="relative min-h-[calc(100vh-64px)] w-full space-y-6 pb-12">
      <div className="relative z-10 space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
        ...
        <header className="mb-8 flex flex-col gap-6 md:flex-row md:items-end justify-between bg-primary/5 p-8 rounded-lg border border-primary/10 dark:border-white/5 shadow-sm mt-4">
                  ...
                  {rows.map((r) => (
                    <MotionItem key={r.id}>
                      <Link
                        ...
                        className="group flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between p-5 rounded-lg border border-slate-200/90 bg-white dark:border-white/5 shadow-sm transform-gpu transition-all hover:border-primary/30 hover:shadow-md"
                      >
