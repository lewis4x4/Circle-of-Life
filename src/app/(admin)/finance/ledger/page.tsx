      ...
      <div className="relative z-10 space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
        ...
        <div className="p-6 sm:p-8 rounded-lg border border-slate-200/60 dark:border-white/5 bg-slate-50/50 shadow-sm relative overflow-hidden transition-all">
          <div className="mb-6 border-b border-slate-200 dark:border-white/5 pb-4 flex items-center justify-between">
            <h3 className="text-xl font-semibold text-slate-900 dark:text-white mt-1">Posted Entries</h3>
                ...
                {rows.map((r) => (
                  <MotionItem key={r.id}>
                    <Link
                      ...
                      className="group flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between p-5 rounded-lg border border-slate-200/90 bg-white dark:border-white/5 shadow-sm transform-gpu transition-all hover:border-emerald-300 dark:hover:border-emerald-500/40 hover:shadow-md"
                    >
                      <div className="min-w-0 flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs font-mono tracking-wider text-slate-500 dark:text-slate-400 uppercase mt-2">
                            Entry: {r.entry_date}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex shrink-0 items-center justify-between sm:justify-end gap-6 sm:w-1/3">
                        <div className="flex flex-col items-start sm:items-end w-full">
                           <span className="font-bold uppercase tracking-wider text-[10px] text-slate-400 mb-1">Posted</span>
                           <span className="text-xs font-mono font-medium text-slate-600 dark:text-slate-300 bg-white border border-slate-200 dark:border-white/10 px-3 py-1.5 rounded-full shadow-sm">
