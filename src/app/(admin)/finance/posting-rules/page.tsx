...
type RuleRow = Database["public"]["Tables"]["gl_posting_rules"]["Row"];
...
export default function GlPostingRulesPage() {
  ...
  }, [supabase, entityId, orgId, canMutate]);
  ...
  useEffect(() => {
    if (ready && canMutate) void loadRules();
  }, [ready, canMutate, loadRules]);
  ...
  return (
    <div className="space-y-6">
      ...
      {error ? <AdminLiveDataFallbackNotice message={error} onRetry={() => void loadRules()} /> : null}
