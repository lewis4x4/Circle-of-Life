    ...
    <div className="relative min-h-[calc(100vh-64px)] w-full space-y-6 pb-12">
      ...
      <div className="relative overflow-visible z-10 w-full mt-4 space-y-8">
        ...
        <div className="relative overflow-visible z-10 w-full mt-4">
          ...
          <Link className="text-primary font-mono text-xs hover:text-primary transition-colors" href="/admin/insurance/policies">
            Policy inventory
          </Link>
          <Link className="text-primary font-mono text-xs hover:text-primary transition-colors" href="/admin/insurance/renewals">
            Renewals
          </Link>
          <Link className="text-primary font-mono text-xs hover:text-primary transition-colors" href="/admin/insurance/renewal-packages">
            Renewal data packages
          </Link>
          <Link className="text-primary font-mono text-xs hover:text-primary transition-colors" href="/admin/insurance/claims">
            Claims
          </Link>
          <Link className="text-primary font-mono text-xs hover:text-primary transition-colors" href="/admin/insurance/coi">
            Certificates of insurance
          </Link>
          <Link className="text-primary font-mono text-xs hover:text-primary transition-colors" href="/admin/insurance/workers-comp">
            Workers&apos; comp
          </Link>
        </div>
          </div>
