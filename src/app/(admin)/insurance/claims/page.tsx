...
export default function InsuranceClaimsPage() {
  ...
  const organizationGapMessage = resolveInsuranceClaimsOrganizationGapMessage({
    authLoading,
    organizationId,
                    ...
                    <div className="flex-1 min-w-0 pl-1">
                      ...
                      <div className="flex gap-6 mt-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="font-semibold text-slate-800 dark:text-slate-200 tabular-nums">
                            {formatInsuranceClaimNumber(r.claim_number)}
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="shrink-0 flex items-center gap-3 pl-1 sm:pl-0">
                      <Link
                        ...
                        className={cn(
                          ...
                          "h-10 rounded-full px-5 font-semibold text-sm bg-white dark:bg-white/5 dark:border-white/10",
                        )}
                      >
                        Manage Claim
                      </Link>
