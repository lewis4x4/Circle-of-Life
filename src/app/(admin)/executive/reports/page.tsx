...
function kpiToCsv(reportName: string, kpi: ExecKpiPayload): string {
  ...
  const lines: string[][] = [
    ...
    ["census.in_house", kpi.census.presence ? String(kpi.census.presence.inHouse) : ""],
    ["census.hospital_hold", kpi.census.presence ? String(kpi.census.presence.hospital) : ""],
    ["census.on_leave", kpi.census.presence ? String(kpi.census.presence.onLeave) : ""],
