      ...
      <div className="relative z-10 space-y-6 max-w-5xl mx-auto">
        <header className="mb-8 flex flex-col gap-6 md:flex-row md:items-end justify-between bg-card p-8 rounded-lg border border-slate-200/50 dark:border-white/5 shadow-sm mt-4">
          <div className="space-y-2">
            <Link href="/admin/infection-control" className={cn(buttonVariants({ variant: "link", size: "sm" }), "h-auto p-0 text-xs text-slate-500 mb-2 uppercase tracking-wider font-bold")}>
              ← Infection control
            </Link>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Link href="/admin/infection-control/staff-illness/new" className={cn(buttonVariants({ size: "default" }), "h-12 px-6 rounded-full font-bold uppercase tracking-wider text-[10px] tap-responsive bg-red-600 hover:bg-red-700 text-white shadow-lg")} >
               + Log Illness
            </Link>
          </div>
        </header>
