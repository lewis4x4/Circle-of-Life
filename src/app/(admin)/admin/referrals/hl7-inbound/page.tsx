        ...
        <header className="mb-8 flex flex-col gap-6 md:flex-row md:items-end justify-between bg-card p-8 rounded-lg border border-slate-200/50 dark:border-white/5 shadow-sm mt-4">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-end">
            ...
            <Link
              ...
              className={cn(buttonVariants({ size: "default" }), "h-14 px-8 rounded-full font-bold uppercase tracking-wider text-xs tap-responsive bg-slate-900 hover:bg-slate-800 text-white shadow-lg flex items-center gap-2 dark:bg-slate-100 dark:hover:bg-white dark:text-slate-900")}
            >
             ...
             {loading ? (
               ...
               <>
                 <div className="hidden sm:grid grid-cols-[1fr_0.5fr_1fr_2fr_1.5fr_1fr] gap-4 px-6 pb-4 border-b border-slate-200 dark:border-white/5 relative z-10 text-left">
                    ...
                    <div className="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-zinc-500">Source</div>
                    <div className="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-zinc-500">Preview</div>
                    <div className="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-zinc-500">Pipeline Lead</div>
                    <div className="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-zinc-500 text-right">Actions</div>
                 </div>
                         ...
                         displayRows.map((row) => (
                           <MotionItem key={row.id}>
                              <div className="grid grid-cols-1 sm:grid-cols-[1fr_0.5fr_1fr_2fr_1.5fr_1fr] gap-4 sm:items-center p-5 rounded-2xl bg-white border border-slate-100 dark:border-white/5 shadow-sm tap-responsive group hover:border-indigo-200 dark:hover:border-indigo-500/30 hover:shadow-lg transition-all duration-300 w-full outline-none">
                                ...
                                <div className="flex flex-col">
                                   <span className="sm:hidden text-[9px] uppercase tracking-wider font-bold text-slate-400 mb-0.5">Status</span>
                                   <Badge className={cn("capitalize w-fit text-[10px] uppercase font-bold tracking-wider border-none shadow-none", 
                                ...
                                <div className="flex flex-col">
                                   <span className="sm:hidden text-[9px] uppercase tracking-wider font-bold text-slate-400 mb-0.5">Trigger</span>
                                ...
                                <div className="flex flex-col gap-1.5">
                                   <span className="sm:hidden text-[9px] uppercase tracking-wider font-bold text-slate-400 mb-0.5">Preview</span>
                                   ...
                                   <button
                                     type="button"
                                     className="self-start text-[10px] font-bold uppercase tracking-wider text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 disabled:opacity-50"
                                ...
                                <div className="flex flex-col sm:justify-center">
                                   <span className="sm:hidden text-[9px] uppercase tracking-wider font-bold text-slate-400 mb-0.5">Lead</span>
                                   {row.linked_referral_lead_id ? (
                                     ...
                                     <button
                                       type="button"
                                       className="inline-flex items-center justify-center rounded-full bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-300 h-8 px-3 text-[10px] font-bold uppercase tracking-wider hover:bg-indigo-100 dark:hover:bg-indigo-500/20 transition-colors disabled:opacity-50 border border-indigo-200 dark:border-indigo-500/20 gap-1.5 shadow-sm w-fit"
                                ...
                                <div className="flex flex-col sm:items-end justify-center">
                                   <span className="sm:hidden text-[9px] uppercase tracking-wider font-bold text-slate-400 mb-2 mt-2">Actions</span>
                                   <div className="flex flex-wrap items-center justify-end gap-2">
                                     <button
                                       type="button"
                                       className="inline-flex items-center justify-center rounded-full bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 h-8 px-3 text-[10px] font-bold uppercase tracking-wider hover:bg-emerald-100 dark:hover:bg-emerald-500/20 transition-colors disabled:opacity-50 border border-emerald-200 dark:border-emerald-500/20 gap-1.5 shadow-sm"
                                     ...
                                     <button
                                       type="button"
                                       className="inline-flex items-center justify-center rounded-full bg-rose-50 dark:bg-rose-500/10 text-rose-600 dark:text-rose-400 h-8 px-3 text-[10px] font-bold uppercase tracking-wider hover:bg-rose-100 dark:hover:bg-rose-500/20 transition-colors disabled:opacity-50 border border-rose-200 dark:border-rose-500/20 gap-1.5 shadow-sm"
                                       disabled={updatingId === row.id}
                                     ...
                                     <button
                                       type="button"
                                       className="inline-flex items-center justify-center rounded-full bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-300 h-8 px-3 text-[10px] font-bold uppercase tracking-wider hover:bg-slate-200 dark:hover:bg-white/10 transition-colors disabled:opacity-50 gap-1.5 shadow-sm"
                                       disabled={updatingId === row.id}
