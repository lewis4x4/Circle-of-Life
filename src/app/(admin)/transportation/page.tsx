        ...
        <KineticGrid className="grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6" staggerMs={75}>
          <div className="h-[160px] lg:col-span-2">
            <V2Card hoverColor="indigo" className="border-primary/20 shadow-[0_8px_30px_rgba(99,102,241,0.05)]">
              <></>
              <MonolithicWatermark value={fleet.length} className="text-primary/5 opacity-50" />
                  ...
                  <MotionList className="space-y-3">
                    {group.rows.map((row) => {
                      ...
                      return (
                        <MotionItem
                          key={row.id}
                          className="rounded-lg border border-slate-200/90 bg-white dark:border-white/5 shadow-sm transform-gpu transition-colors hover:border-primary/30 group overflow-hidden"
                        >
                          <Link
                 ...
                 <MotionList className="space-y-3">
                   {inspections.slice(0, 3).map(row => (
                     <MotionItem key={row.id} className="p-4 rounded-lg border border-slate-200/60 dark:border-white/5 bg-white flex gap-4 items-center shadow-sm">
                       ...
                       <span className="text-[10px] font-bold text-primary text-right bg-primary/5 border border-primary/10 px-3 py-1.5 rounded-full shrink-0">
