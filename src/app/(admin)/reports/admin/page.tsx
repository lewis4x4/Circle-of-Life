...
export default function ReportsGovernancePage() {
  ...
  return (
    <>
      ...
      {!canManage && (
         <div className="rounded-lg border border-amber-500/20 bg-amber-500/10 p-6 text-sm text-amber-600 dark:text-amber-400 font-medium tracking-wide flex items-center gap-4">
                             ...
                             <div className="flex flex-col gap-2 md:col-span-2">
                                ...
                                <div className="flex flex-wrap gap-2">
                                  ...
                                  {row.locked_definition && (
                                    <Badge className="bg-amber-50 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300 border border-amber-200 dark:border-amber-800 uppercase tracking-wider font-mono text-[9px] font-bold shadow-sm px-2.5 py-1 rounded-full">Locked</Badge>
                                  )}
                                </div>
                             </div>
