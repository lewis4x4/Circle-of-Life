  ...
  return (
    <>
      ...
      {canManage && (
        <div className="p-6 sm:p-8 rounded-lg border border-slate-200/60 dark:border-white/5 bg-slate-50/50 shadow-sm relative overflow-visible mb-6 z-10 w-full transition-all">
          <div className="mb-6 border-b border-slate-200 dark:border-white/5 pb-4">
            <h3 className="text-xl font-semibold text-slate-900 dark:text-white">Create Pack</h3>
          ...
          <div className="grid gap-4 flex-col lg:flex-row lg:grid-cols-[2fr_1fr_auto] items-center">
            ...
            <div className="flex w-full lg:w-auto gap-2">
              <Button className="rounded-2xl font-mono uppercase tracking-wider text-[11px] font-bold h-12 hover:-translate-y-0.5 transition-transform shadow-lg px-8 flex-1" onClick={() => void onCreatePack()}>
                Create
              </Button>
              <Button variant="outline" className="rounded-2xl font-mono uppercase tracking-wider text-[11px] font-bold h-12 hover:-translate-y-0.5 transition-transform shadow-sm flex-1 bg-white/50 dark:bg-white/5" onClick={() => void onCreateSurveyPack()}>
                Survey Visit Pack
              </Button>
            </div>
          </div>
      ...
      <div className="p-6 sm:p-8 rounded-lg border border-slate-200/60 dark:border-white/5 bg-slate-50/50 shadow-sm relative overflow-visible z-10 w-full transition-all">
          <div className="mb-6 border-b border-slate-200 dark:border-white/5 pb-4">
            <h3 className="text-xl font-semibold text-slate-900 dark:text-white">Pack Registry</h3>
          </div>
          {loading ? (
                           ...
                           <div className="flex flex-col gap-2">
                              ...
                              <div className="flex flex-wrap gap-2">
                                ...
                                {!pack.active ? (
                                  ...
                                  <Badge className="bg-emerald-50 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/20 uppercase tracking-wider font-mono text-[9px] font-bold shadow-sm px-2.5 py-1 rounded-full">Active</Badge>
                                )}
                              </div>
                           </div>
                           <div className="flex flex-col gap-2 align-right text-left md:text-right">
                              <span className="text-[9px] uppercase font-mono tracking-wider text-slate-400">Operations</span>
