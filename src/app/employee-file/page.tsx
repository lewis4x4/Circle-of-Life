...
export default async function MyEmployeeFile({ searchParams }: { searchParams: Promise<{ staff?: string }> }) {
  ...
  if (error) return <div className="p-6"><h1>My employee file</h1><p role="alert">Your employee record could not be loaded. Please sign in again or contact your administrator.</p></div>;
