        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between py-6">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm text-muted-foreground">
              ...
              <StatuteCitation statuteCode="59A-36.018" className="font-medium text-primary">
                FAC 59A-36.018
              </StatuteCitation>{" "}
              (see statute tooltip).
            </p>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/admin/compliance/deficiencies/new" className={cn(buttonVariants({ size: "sm" }), "text-[10px] font-mono")}>
              Add deficiencies
            </Link>
            <Link href="/admin/certifications" className={cn(buttonVariants({ variant: "secondary", size: "sm" }), "text-[10px] font-mono bg-primary/5 text-primary hover:bg-primary/10")}>
              Certifications
            </Link>
            {/* Enhanced tier links */}
            <Link href="/admin/compliance/rules" className={cn(buttonVariants({ variant: "outline", size: "sm" }), "bg-primary/5 dark:bg-primary/20 text-[10px] font-mono text-primary")}>
              Compliance Rules
            </Link>
            <Link href="/admin/compliance/scan" className={cn(buttonVariants({ variant: "outline", size: "sm" }), "bg-primary/5 dark:bg-primary/20 text-[10px] font-mono text-primary")}>
              Run Scan
            </Link>
            <Link href="/admin/compliance/deficiencies/analysis" className={cn(buttonVariants({ variant: "outline", size: "sm" }), "bg-primary/5 dark:bg-primary/20 text-[10px] font-mono text-primary")}>
              Analysis
            </Link>
                ...
                <MotionItem key={row.id} className="flex items-center gap-3 min-h-[36px] px-[13px] py-2 rounded-lg border border-border bg-card hover:bg-muted/40 hover:-translate-y-0.5 transition-all duration-[var(--motion-duration-micro)] ease-[var(--motion-ease)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0 group cursor-pointer">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 w-full">
                    ...
                    <Link
                      ...
                      className={cn(buttonVariants({ variant: "outline", size: "sm" }), "w-full sm:w-auto font-mono text-[10px] shadow-none bg-transparent border-slate-300 dark:border-slate-700 text-slate-800 dark:text-slate-200 group-hover:border-primary group-hover:text-primary")}
                    >
                      Manage Finding
                    </Link>
                  </div>
        ...
        {reminders.length > 0 && (
          <div className="rounded-lg p-6 border border-border bg-card">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/admin/compliance/deficiencies/new" className={cn(buttonVariants({ variant: "outline", size: "sm" }), "bg-primary/5 dark:bg-primary/20 text-[10px] font-mono text-primary")}>
                View All
              </Link>
            </div>
            <MotionList className="space-y-3">
