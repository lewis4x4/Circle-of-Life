...
import { HavenNavLink } from "@/components/layout/navigation-pending";
...
export type HavenShellBrandLinkProps = Omit<ComponentProps<typeof HavenNavLink>, "children"> & {
...
export function HavenShellBrandLink({ className, children, ...props }: HavenShellBrandLinkProps) {
  return (
    <HavenNavLink className={cn("flex min-h-9 items-center gap-3", className)} {...props}>
