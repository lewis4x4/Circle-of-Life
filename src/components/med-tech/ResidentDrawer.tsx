      ...
      <div className="fixed right-0 top-0 bottom-0 z-50 w-full max-w-sm bg-slate-900 border-l border-slate-700 shadow-2xl flex flex-col">
        ...
        <div className="px-6 py-5 border-b border-slate-800 flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">{resident.note}</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5">
              ...
              <div className="space-y-2">
                {residentPasses.map((p) => (
                  ...
                  >
                    ...
                    <div className="text-xs text-muted-foreground mt-0.5">{p.dose}</div>
                    {p.hold && (
          ...
          <div className="rounded-xl bg-slate-800/40 ring-1 ring-slate-700 p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <h3 className="text-sm font-semibold text-muted-foreground">Vitals</h3>
            </div>
        ...
        <div className="p-4 border-t border-slate-800 flex gap-2">
          ...
          <button className="flex-1 py-2.5 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground text-sm font-semibold transition flex items-center justify-center gap-2">
