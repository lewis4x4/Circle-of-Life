          ...
          <div className="col-span-1 h-[160px]">
            <V2Card hoverColor="slate" className="flex flex-col">
              ...
              <div className="flex flex-col gap-1 text-[11px] overflow-y-auto flex-1">
                <Link className="text-primary font-mono hover:text-primary transition-colors" href="/admin/finance/chart-of-accounts">
                  Chart of accounts
                </Link>
                <Link className="text-primary font-mono hover:text-primary transition-colors" href="/admin/finance/journal-entries">
                  Journal entries
                </Link>
                <Link className="text-primary font-mono hover:text-primary transition-colors" href="/admin/finance/ledger">
                  Posted ledger (read-only)
                </Link>
                <Link className="text-primary font-mono hover:text-primary transition-colors" href="/admin/finance/trial-balance">
                  Trial balance
                </Link>
                <Link className="text-primary font-mono hover:text-primary transition-colors" href="/admin/finance/posting-rules">
                  GL posting rules
                </Link>
                <Link className="text-primary font-mono hover:text-primary transition-colors" href="/admin/finance/period-close">
                  Period close
                </Link>
                <Link className="text-primary font-mono hover:text-primary transition-colors" href="/admin/finance/forecast">
                  Forecast
                </Link>
                <Link className="text-primary font-mono hover:text-primary transition-colors" href="/admin/finance/budget">
                  Budget vs actual
                </Link>
                <Link className="text-primary font-mono hover:text-primary transition-colors" href="/admin/finance/gl-settings">
                  GL settings
                </Link>
              </div>
            </V2Card>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg border border-border bg-card shadow-sm">
                ...
                <Link
                  ...
                  className="mt-3 inline-block text-[11px] font-mono text-primary hover:underline"
                >
                  Open period close →
                </Link>
              </div>
