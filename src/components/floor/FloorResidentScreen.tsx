...
import { clockWithoutDayHalf, fetchResidentDetail, floorVisitorTypeWord, knowBeforeItems, nextOpenCheck, nextOpeningCheck, recentCheckItems, type InfoItem } from "@/lib/floor/resident-detail";
