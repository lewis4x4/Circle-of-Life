...
function StandUpSession({ userId }: { userId: string }) {
  ...
  return <div className="mx-auto max-w-6xl space-y-6 p-4 pb-12 md:p-6">
    <header className="flex flex-wrap items-start justify-between gap-4">
      <div><h1 className="text-2xl font-semibold">Weekly Stand Up</h1><p className="mt-1 text-sm text-muted-foreground">Monday operations · complete by 8:45 a.m. Eastern</p></div>
