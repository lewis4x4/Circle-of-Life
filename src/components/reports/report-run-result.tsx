...
const GROUP_ICONS: Record<string, ReactNode> = {
  ...
  Compliance: <Shield className="h-4 w-4 text-primary" aria-hidden />,
  "Survey readiness": <ClipboardList className="h-4 w-4 text-primary" aria-hidden />,
  ...
  "Staffing coverage": <Users className="h-4 w-4 text-primary" aria-hidden />,
  "Labor & overtime": <Activity className="h-4 w-4 text-primary" aria-hidden />,
