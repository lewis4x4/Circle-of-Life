...
Every limitation in the review remains in force. This is still synthetic-only, with no live transport, no scheduler endpoint, no credential UI and no hosted deployment.
