# HCOL reconciliation register

Source inspection at isolated baseline `9db72d2d`, 8 September 2026. This is an implementation ledger, not issued Linear tickets or approved business policy. No item is certified fully implemented by source existence. Active Remaining Roadmap repairs are unmerged and reported not deployed.
...
| HCOL-08 | Accountable next action | Tour owner preservation and stale-save protection completed with independent approval. One open next action, owner/backup acceptance, evidence-backed completion/replacement, history and pipeline exceptions implemented; staff acceptance and broader coordination remain open. |
...
| HCOL-16 | Early-residency follow-up | Reuse resident tasks/observations; proposed checks require Operations timings. |
| HCOL-17 | Acknowledged handoffs | Reuse shift handoffs/notes and active FL-001 assignments; receiving acknowledgment remains open. |
| HCOL-18 | Staffing pressure | Existing assignments/adequacy; approved B-12 requirements and overtime units needed. |
...
| HCOL-22 | Durable recovery and coverage | Return follow-up and referral command receipts survive uncertain results/reload; referral browser journal retains IDs only. Other lifecycle/offline drafts and cross-facility recovery remain open. |
...
| HCOL-28 | Authorized aggregate publication | Separate Front Office signed source-owned feed contract; audience approval and publisher remain open. |

Evidence: `src/lib/executive/standup.ts`; `src/components/residents/ResidentPresenceControl.tsx`; `src/app/(admin)/admin/referrals/[id]/page.tsx`; `docs/specs/01-referral-inquiry.md`; migrations 002, 017, 024, 027, 077, 081, 085, 096, 098, 141, 198, 220, 301, 317 and 321. Active repair evidence: sibling Remaining Roadmap progress document. Front Office authority: `/Users/brianlewis/COL-Front-Office/docs/operations/END-TO-END-BUILD-HANDOFF.md`.
