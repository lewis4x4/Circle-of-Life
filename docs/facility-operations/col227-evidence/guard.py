...
def verify(ready_path):
 ...
 require(r['approved_by_parent'] is True and r['scope']=='COL-227 synthetic fixture and browser proof' and r['phase'] in ['before','after'],'Explicit parent readiness required')
