...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    cook_id, inst,
    'synthetic-b37cde17af@example.invalid', pw, ts,
    '{"provider":"email","providers":["email"],"app_role":"dietary"}',
    '{"full_name":"Synthetic full_name 27782b3873","email_verified":true}',
  ...
  VALUES (
    ...
    cook_id,
    '{"sub":"a0000000-0000-0000-0000-000000000016","email":"synthetic-b37cde17af@example.invalid","email_verified":true,"phone_verified":false}',
  ...
  INSERT INTO user_profiles (id, organization_id, email, full_name, phone, app_role) VALUES
    (cook_id, org, 'synthetic-b37cde17af@example.invalid', 'Synthetic full_name 27782b3873', '202-555-0136', 'dietary')
  ON CONFLICT (id) DO UPDATE SET
