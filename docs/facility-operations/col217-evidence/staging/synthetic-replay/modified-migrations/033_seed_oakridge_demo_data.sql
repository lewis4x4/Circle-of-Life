...
BEGIN
  ...
  VALUES
    ('a0000000-0000-0000-0000-000000000001', inst, 'synthetic-14f6677eab@example.invalid', pw, ts,
     '{"provider":"email","providers":["email"]}', '{"full_name":"Synthetic full_name b95b8fc4b8"}',
     'authenticated','authenticated', ts, ts, ''),
    ('a0000000-0000-0000-0000-000000000002', inst, 'synthetic-5bf8a0c32f@example.invalid', pw, ts,
     '{"provider":"email","providers":["email"]}', '{"full_name":"Synthetic full_name 9a4451a0ee"}',
     'authenticated','authenticated', ts, ts, ''),
    ('a0000000-0000-0000-0000-000000000003', inst, 'synthetic-b1223c35ce@example.invalid', pw, ts,
     '{"provider":"email","providers":["email"]}', '{"full_name":"Synthetic full_name c56a8b8ad4"}',
     'authenticated','authenticated', ts, ts, ''),
    ('a0000000-0000-0000-0000-000000000004', inst, 'synthetic-a3a3a31fef@example.invalid', pw, ts,
     '{"provider":"email","providers":["email"]}', '{"full_name":"Synthetic full_name f50eb080d9"}',
     'authenticated','authenticated', ts, ts, ''),
    ('a0000000-0000-0000-0000-000000000005', inst, 'synthetic-54777b9a48@example.invalid', pw, ts,
     '{"provider":"email","providers":["email"]}', '{"full_name":"Synthetic full_name 14dec61b7e"}',
     'authenticated','authenticated', ts, ts, ''),
    ('a0000000-0000-0000-0000-000000000006', inst, 'synthetic-f0197b370b@example.invalid', pw, ts,
     '{"provider":"email","providers":["email"]}', '{"full_name":"Synthetic full_name 1182988036"}',
     'authenticated','authenticated', ts, ts, ''),
    ('a0000000-0000-0000-0000-000000000007', inst, 'synthetic-5c41d27af6@example.invalid', pw, ts,
     '{"provider":"email","providers":["email"]}', '{"full_name":"Synthetic full_name 8d29b5387b"}',
     'authenticated','authenticated', ts, ts, '')
...
INSERT INTO user_profiles (id, organization_id, email, full_name, phone, app_role) VALUES
  ('a0000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000001','synthetic-14f6677eab@example.invalid','Synthetic full_name b95b8fc4b8','202-555-0149','owner'),
  ('a0000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000001','synthetic-5bf8a0c32f@example.invalid','Synthetic full_name 9a4451a0ee','202-555-0101','facility_admin'),
  ('a0000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000001','synthetic-b1223c35ce@example.invalid','Synthetic full_name c56a8b8ad4','202-555-0151','nurse'),
  ('a0000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000001','synthetic-a3a3a31fef@example.invalid','Synthetic full_name f50eb080d9','202-555-0186','caregiver'),
  ('a0000000-0000-0000-0000-000000000005','00000000-0000-0000-0000-000000000001','synthetic-54777b9a48@example.invalid','Synthetic full_name 14dec61b7e','202-555-0118','caregiver'),
  ('a0000000-0000-0000-0000-000000000006','00000000-0000-0000-0000-000000000001','synthetic-f0197b370b@example.invalid','Synthetic full_name 1182988036','202-555-0174','family'),
  ('a0000000-0000-0000-0000-000000000007','00000000-0000-0000-0000-000000000001','synthetic-5c41d27af6@example.invalid','Synthetic full_name 8d29b5387b','202-555-0137','family')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO residents (id, facility_id, organization_id, bed_id, first_name, last_name, preferred_name, date_of_birth, gender, ssn_last_four, status, acuity_level, admission_date, primary_physician_name, primary_physician_phone, primary_diagnosis, diagnosis_list, allergy_list, diet_order, code_status, ambulatory, assistive_device, fall_risk_level, elopement_risk, wandering_risk, primary_payer, monthly_base_rate, monthly_care_surcharge, monthly_total_rate, rate_effective_date, responsible_party_name, responsible_party_relationship, responsible_party_phone, emergency_contact_1_name, emergency_contact_1_relationship, emergency_contact_1_phone, preferred_wake_time, preferred_bed_time) VALUES
  ('c0000000-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','b0000000-0000-0000-0000-000000000101',
   'Synthetic first_name 522ce7057f','Synthetic last_name 545f5aaa37','Maggie','1943-06-15','female','4821','active','level_3','2024-03-01',
   'Dr. Patricia Hayes','202-555-0120','Alzheimer''s disease, early onset',
   ...
   'Synthetic full_name 1182988036','Son','202-555-0174',
   'Synthetic full_name 1182988036','Son','202-555-0174','07:00','20:30'),
  ...
  ('c0000000-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','b0000000-0000-0000-0000-000000000102',
   'Synthetic first_name 0a348ac4d9','Synthetic last_name 3abd72ec63',NULL,'1947-09-22','male','7193','active','level_2','2023-11-15',
   'Dr. Michael Rivera','202-555-0123','COPD',
   ...
   'Synthetic full_name 8d29b5387b','Daughter','202-555-0137',
   'Synthetic full_name 8d29b5387b','Daughter','202-555-0137','06:30','21:00'),
  ...
  ('c0000000-0000-0000-0000-000000000003','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','b0000000-0000-0000-0000-000000000103',
   'Synthetic first_name e5a726a3cf','Synthetic last_name d17108747e','Dot','1940-02-08','female','3345','active','level_2','2024-01-10',
   'Dr. Patricia Hayes','202-555-0120','Vascular dementia',
   ...
   'Karen Williams','Daughter','202-555-0184',
   'Karen Williams','Daughter','202-555-0184','07:30','20:00'),
  ...
  ('c0000000-0000-0000-0000-000000000004','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','b0000000-0000-0000-0000-000000000104',
   'Synthetic first_name befa156f02','Synthetic last_name 4b0baa7519','Art','1949-11-30','male','5567','active','level_1','2024-06-01',
   'Dr. James Crawford','202-555-0161','Essential hypertension',
   ...
   'Thomas Pennington','Son','202-555-0193',
   'Thomas Pennington','Son','202-555-0193','06:00','22:00'),
  ...
  ('c0000000-0000-0000-0000-000000000005','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','b0000000-0000-0000-0000-000000000201',
   'Synthetic first_name 79fe4c43a9','Synthetic last_name c1d35cc347',NULL,'1935-04-19','female','8912','active','level_3','2023-08-20',
   'Dr. Michael Rivera','202-555-0123','Parkinson''s disease',
   ...
   'Diane Anderson','Daughter','202-555-0108',
   'Diane Anderson','Daughter','202-555-0108','07:00','19:30'),
  ...
  ('c0000000-0000-0000-0000-000000000006','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','b0000000-0000-0000-0000-000000000202',
   'Synthetic first_name 77646f5a4f','Synthetic last_name db044f19bc',NULL,'1953-07-04','male','2234','active','level_1','2025-01-15',
   'Dr. James Crawford','202-555-0161','Type 2 Diabetes',
   ...
   'Carmen Martinez','Wife','202-555-0103',
   'Carmen Martinez','Wife','202-555-0103','06:30','21:30'),
  ...
  ('c0000000-0000-0000-0000-000000000007','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','b0000000-0000-0000-0000-000000000203',
   'Synthetic first_name 0a4992ea44','Synthetic last_name 8e924025a2','Ginny','1937-12-25','female','6678','active','level_2','2024-09-01',
   'Dr. Patricia Hayes','202-555-0120','Congestive heart failure',
   ...
   'Mark Taylor','Son','202-555-0169',
   'Mark Taylor','Son','202-555-0169','07:00','20:00'),
  ...
  ('c0000000-0000-0000-0000-000000000008','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','b0000000-0000-0000-0000-000000000204',
   'Synthetic first_name 4748d4c802','Synthetic last_name 5eb67f9f84','Walt','1944-08-10','male','9901','hospital_hold','level_2','2024-04-15',
   'Dr. Michael Rivera','202-555-0123','COPD exacerbation',
   ...
   'Susan Brown','Wife','202-555-0177',
   'Susan Brown','Wife','202-555-0177','07:00','21:00')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO staff (id, user_id, facility_id, organization_id, first_name, last_name, phone, email, staff_role, employment_status, hire_date, hourly_rate, is_full_time) VALUES
  ('50000000-0000-0000-0000-000000000001','a0000000-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','Synthetic first_name e1fc45f788','Synthetic last_name ca700c8aa0','202-555-0101','synthetic-5bf8a0c32f@example.invalid','administrator','active','2014-03-01',3500,true),
  ('50000000-0000-0000-0000-000000000002','a0000000-0000-0000-0000-000000000003','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','Synthetic first_name d233633d95','Synthetic last_name d17108747e','202-555-0151','synthetic-b1223c35ce@example.invalid','lpn','active','2020-06-15',2800,true),
  ('50000000-0000-0000-0000-000000000003','a0000000-0000-0000-0000-000000000004','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','Synthetic first_name 94aec9fbed','Synthetic last_name e9b71991b7','202-555-0186','synthetic-a3a3a31fef@example.invalid','cna','active','2022-01-10',1600,true),
  ('50000000-0000-0000-0000-000000000004','a0000000-0000-0000-0000-000000000005','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','Synthetic first_name 119c9ae6f9','Synthetic last_name 265ce76730','202-555-0118','synthetic-54777b9a48@example.invalid','cna','active','2023-04-01',1600,true),
  ('50000000-0000-0000-0000-000000000005',NULL,'00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','Synthetic first_name 79a6a933df','Synthetic last_name 4458e908dd','202-555-0155','synthetic-405dff5a03@example.invalid','activities_director','active','2019-09-01',2200,true),
  ('50000000-0000-0000-0000-000000000006',NULL,'00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','Synthetic first_name 4007d46292','Synthetic last_name dc355ec75a','202-555-0166','synthetic-0013630720@example.invalid','dietary_manager','active','2021-02-01',2000,true)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO activities (id, facility_id, organization_id, name, description, default_day_of_week, default_start_time, default_duration_minutes, facilitator, is_recurring) VALUES
  ('ac000000-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','Morning Exercise','Seated stretching and light range-of-motion exercises',ARRAY[1,2,3,4,5],'09:00',45,'Synthetic full_name ba9a091a97',true),
  ('ac000000-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','Bingo','Weekly bingo with prizes',ARRAY[3],'14:00',60,'Synthetic full_name ba9a091a97',true),
  ...
  ('ac000000-0000-0000-0000-000000000004','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','Art Class','Watercolor painting and crafts',ARRAY[5],'10:00',60,'Synthetic full_name ba9a091a97',true),
  ...
  ('ac000000-0000-0000-0000-000000000006','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','Family Visitation Day','Open visitation with refreshments',ARRAY[0],'13:00',180,'Synthetic full_name 9a4451a0ee',true)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO activity_sessions (id, activity_id, facility_id, organization_id, session_date, start_time, end_time, facilitator_name, cancelled) VALUES
  ('a5000000-0000-0000-0000-000000000001','ac000000-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001',CURRENT_DATE,     (CURRENT_DATE + '09:00'::time)::timestamptz,(CURRENT_DATE + '09:45'::time)::timestamptz,'Synthetic full_name ba9a091a97',false),
  ('a5000000-0000-0000-0000-000000000002','ac000000-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001',CURRENT_DATE + 1, (CURRENT_DATE + 1 + '14:00'::time)::timestamptz,(CURRENT_DATE + 1 + '15:00'::time)::timestamptz,'Synthetic full_name ba9a091a97',false),
  ...
  ('a5000000-0000-0000-0000-000000000004','ac000000-0000-0000-0000-000000000004','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001',CURRENT_DATE + 3, (CURRENT_DATE + 3 + '10:00'::time)::timestamptz,(CURRENT_DATE + 3 + '11:00'::time)::timestamptz,'Synthetic full_name ba9a091a97',false),
  ...
  ('a5000000-0000-0000-0000-000000000006','ac000000-0000-0000-0000-000000000006','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001',CURRENT_DATE + 5, (CURRENT_DATE + 5 + '13:00'::time)::timestamptz,(CURRENT_DATE + 5 + '16:00'::time)::timestamptz,'Synthetic full_name 9a4451a0ee',false),
  ('a5000000-0000-0000-0000-000000000007','ac000000-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001',CURRENT_DATE + 7, (CURRENT_DATE + 7 + '09:00'::time)::timestamptz,(CURRENT_DATE + 7 + '09:45'::time)::timestamptz,'Synthetic full_name ba9a091a97',false),
  ...
  ('a5000000-0000-0000-0000-000000000009','ac000000-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001',CURRENT_DATE - 2, (CURRENT_DATE - 2 + '09:00'::time)::timestamptz,(CURRENT_DATE - 2 + '09:45'::time)::timestamptz,'Synthetic full_name ba9a091a97',true)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO resident_payers (id, resident_id, facility_id, organization_id, payer_type, is_primary, payer_name, effective_date) VALUES
  ('b4000000-0000-0000-0000-000000000001','c0000000-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','private_pay',true,'Synthetic full_name 1182988036','2024-03-01'),
...
INSERT INTO payments (id, resident_id, facility_id, organization_id, entity_id, invoice_id, payment_date, amount, payment_method, reference_number, payer_name) VALUES
  ('b7000000-0000-0000-0000-000000000001','c0000000-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','00000000-0000-0000-0001-000000000001','b5000000-0000-0000-0000-000000000001','2026-03-10',500000,'check','1847','Synthetic full_name 1182988036'),
...
INSERT INTO staffing_ratio_snapshots (id, facility_id, organization_id, shift, residents_present, staff_on_duty, ratio, required_ratio, is_compliant, staff_detail) VALUES
  ('bb000000-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000001','00000000-0000-0000-0000-000000000001','day',7,3,2.33,5.00,true,'[{"name":"Synthetic full_name f50eb080d9","role":"cna"},{"name":"Synthetic full_name 14dec61b7e","role":"cna"},{"name":"Synthetic full_name c56a8b8ad4","role":"lpn"}]')
ON CONFLICT (id) DO NOTHING;
