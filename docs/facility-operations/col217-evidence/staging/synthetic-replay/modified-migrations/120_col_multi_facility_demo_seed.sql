...
INSERT INTO residents (id, facility_id, organization_id, bed_id, first_name, last_name, preferred_name, date_of_birth, gender, ssn_last_four, status, acuity_level, admission_date, primary_physician_name, primary_physician_phone, primary_diagnosis, diagnosis_list, allergy_list, diet_order, code_status, ambulatory, assistive_device, fall_risk_level, elopement_risk, wandering_risk, primary_payer, monthly_base_rate, monthly_care_surcharge, monthly_total_rate, rate_effective_date, responsible_party_name, responsible_party_relationship, responsible_party_phone, emergency_contact_1_name, emergency_contact_1_relationship, emergency_contact_1_phone, preferred_wake_time, preferred_bed_time) VALUES
  ('c0000002-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000002','00000000-0000-0000-0000-000000000001','b0000002-0000-0000-0000-000000000101','Synthetic first_name 2bd806c97f','Synthetic last_name cfa5b48389','Ali','1941-03-10','female','2211','active','level_2','2024-02-01','Dr. Hayes','202-555-0120','Hypertension',ARRAY['Hypertension','Osteoarthritis'],ARRAY[]::text[],'Regular','full_code',true,'Cane','moderate',false,false,'private_pay',425000,35000,460000,'2024-02-01','Paul Rivers','Son','202-555-0152','Paul Rivers','Son','202-555-0152','07:00','21:00'),
  ('c0000002-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000002','00000000-0000-0000-0000-000000000001','b0000002-0000-0000-0000-000000000102','Synthetic first_name 6700869c8f','Synthetic last_name b3986952b1',NULL,'1946-07-22','male','3322','active','level_1','2023-09-15','Dr. Rivera','202-555-0123','Type 2 Diabetes',ARRAY['Type 2 DM'],ARRAY['Sulfa'],'Diabetic','full_code',true,NULL,'standard',false,false,'ltc_insurance',425000,0,425000,'2023-09-15','Synthetic full_name 145c3c94af Jr','Son','202-555-0182','Synthetic full_name 145c3c94af Jr','Son','202-555-0182','06:30','22:00'),
  ('c0000002-0000-0000-0000-000000000003','00000000-0000-0000-0002-000000000002','00000000-0000-0000-0000-000000000001','b0000002-0000-0000-0000-000000000103','Synthetic first_name 7814459b3f','Synthetic last_name 04db248bd1',NULL,'1939-11-05','female','4433','active','level_3','2024-05-20','Dr. Hayes','202-555-0120','Alzheimer''s disease',ARRAY['Alzheimer''s disease'],ARRAY['Penicillin'],'Mechanical soft','full_code',true,'Walker','high',false,true,'medicaid_oss',425000,75000,500000,'2024-05-20','Mai Nguyen','Daughter','202-555-0116','Mai Nguyen','Daughter','202-555-0116','07:30','20:00'),
  ('c0000002-0000-0000-0000-000000000004','00000000-0000-0000-0002-000000000002','00000000-0000-0000-0000-000000000001','b0000002-0000-0000-0000-000000000104','Synthetic first_name c898ab690b','Synthetic last_name c20d77a59f','Synthetic first_name c898ab690b','1950-01-30','male','5544','active','level_1','2025-02-01','Dr. Crawford','202-555-0161','Osteoarthritis',ARRAY['OA'],ARRAY[]::text[],'Regular','full_code',true,NULL,'standard',false,false,'private_pay',425000,0,425000,'2025-02-01','Synthetic full_name fb3e640483','Self','202-555-0146','Synthetic full_name fb3e640483','Self','202-555-0146','06:00','22:30')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO staff (id, user_id, facility_id, organization_id, first_name, last_name, phone, email, staff_role, employment_status, hire_date, hourly_rate, is_full_time) VALUES
  ('50000002-0000-0000-0000-000000000001',NULL,'00000000-0000-0000-0002-000000000002','00000000-0000-0000-0000-000000000001','Synthetic first_name 26ae784d19','Synthetic last_name c928225c4c','202-555-0179','synthetic-2455491430@example.invalid','administrator','active','2016-04-01',3400,true),
  ('50000002-0000-0000-0000-000000000002',NULL,'00000000-0000-0000-0002-000000000002','00000000-0000-0000-0000-000000000001','Synthetic first_name 8535e86c81','Synthetic last_name 2e11f2c2a8','202-555-0121','synthetic-b1dbeadf77@example.invalid','lpn','active','2019-08-01',2700,true),
  ('50000002-0000-0000-0000-000000000003',NULL,'00000000-0000-0000-0002-000000000002','00000000-0000-0000-0000-000000000001','Synthetic first_name a6ae07ad55','Synthetic last_name 2daa8442c0','202-555-0101','synthetic-f987c940e3@example.invalid','cna','active','2021-03-15',1650,true),
  ('50000002-0000-0000-0000-000000000004',NULL,'00000000-0000-0000-0002-000000000002','00000000-0000-0000-0000-000000000001','Synthetic first_name cf3a3bbe33','Synthetic last_name f8b003e0b3','202-555-0170','synthetic-ced9721e79@example.invalid','cna','active','2022-11-01',1650,true)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO activities (id, facility_id, organization_id, name, description, default_day_of_week, default_start_time, default_duration_minutes, facilitator, is_recurring) VALUES
  ('ac000002-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000002','00000000-0000-0000-0000-000000000001','Walking Club','Outdoor courtyard walk weather permitting',ARRAY[1,3,5],'10:00',30,'Synthetic full_name e64627d36b',true),
  ('ac000002-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000002','00000000-0000-0000-0000-000000000001','Trivia','Group trivia in common room',ARRAY[2,4],'14:00',45,'Synthetic full_name 7c5e860605',true)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO activity_sessions (id, activity_id, facility_id, organization_id, session_date, start_time, end_time, facilitator_name, cancelled) VALUES
  ('a5000002-0000-0000-0000-000000000001','ac000002-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000002','00000000-0000-0000-0000-000000000001',CURRENT_DATE,(CURRENT_DATE + '10:00'::time)::timestamptz,(CURRENT_DATE + '10:30'::time)::timestamptz,'Synthetic full_name e64627d36b',false),
  ('a5000002-0000-0000-0000-000000000002','ac000002-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000002','00000000-0000-0000-0000-000000000001',CURRENT_DATE + 1,(CURRENT_DATE + 1 + '14:00'::time)::timestamptz,(CURRENT_DATE + 1 + '14:45'::time)::timestamptz,'Synthetic full_name 7c5e860605',false)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO staffing_ratio_snapshots (id, facility_id, organization_id, shift, residents_present, staff_on_duty, ratio, required_ratio, is_compliant, staff_detail) VALUES
  ('bb000002-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000002','00000000-0000-0000-0000-000000000001','day',4,2,2.0,5.00,true,'[{"name":"Synthetic full_name e64627d36b","role":"cna"},{"name":"Synthetic full_name 68af917114","role":"cna"}]')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO residents (id, facility_id, organization_id, bed_id, first_name, last_name, preferred_name, date_of_birth, gender, ssn_last_four, status, acuity_level, admission_date, primary_physician_name, primary_physician_phone, primary_diagnosis, diagnosis_list, allergy_list, diet_order, code_status, ambulatory, assistive_device, fall_risk_level, elopement_risk, wandering_risk, primary_payer, monthly_base_rate, monthly_care_surcharge, monthly_total_rate, rate_effective_date, responsible_party_name, responsible_party_relationship, responsible_party_phone, emergency_contact_1_name, emergency_contact_1_relationship, emergency_contact_1_phone, preferred_wake_time, preferred_bed_time) VALUES
  ('c0000003-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001','b0000003-0000-0000-0000-000000000101','Synthetic first_name 0ce93c9606','Synthetic last_name 683b531f41',NULL,'1942-04-18','female','6611','active','level_2','2024-01-10','Dr. Hayes','202-555-0120','CHF',ARRAY['CHF','HTN'],ARRAY[]::text[],'Low sodium','full_code',true,'Walker','moderate',false,false,'private_pay',425000,35000,460000,'2024-01-10','Synthetic full_name ddc3aa9403 Jr','Niece','202-555-0164','Synthetic full_name ddc3aa9403 Jr','Niece','202-555-0164','07:00','20:30'),
  ('c0000003-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001','b0000003-0000-0000-0000-000000000102','Synthetic first_name 960f984285','Synthetic last_name dc3d50da8d',NULL,'1948-09-01','male','7722','active','level_1','2023-12-05','Dr. Rivera','202-555-0123','BPH',ARRAY['BPH'],ARRAY[]::text[],'Regular','full_code',true,NULL,'standard',false,false,'private_pay',425000,0,425000,'2023-12-05','Synthetic full_name 0c7888d14e','Son','202-555-0141','Synthetic full_name 0c7888d14e','Son','202-555-0141','06:30','21:30'),
  ('c0000003-0000-0000-0000-000000000003','00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001','b0000003-0000-0000-0000-000000000103','Synthetic first_name 030923893f','Synthetic last_name ff7386f91e','Synthetic first_name 030923893f','1938-06-25','female','8833','active','level_3','2024-07-12','Dr. Hayes','202-555-0120','Vascular dementia',ARRAY['Vascular dementia'],ARRAY['Latex'],'Pureed','full_code',true,'Wheelchair','high',false,true,'medicaid_oss',425000,75000,500000,'2024-07-12','Carlos Morales','Son','202-555-0163','Carlos Morales','Son','202-555-0163','08:00','19:00'),
  ('c0000003-0000-0000-0000-000000000004','00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001','b0000003-0000-0000-0000-000000000104','Synthetic first_name 927a3aed18','Synthetic last_name c8711d5421',NULL,'1951-02-14','male','9944','active','level_1','2025-01-20','Dr. Crawford','202-555-0161','Hyperlipidemia',ARRAY['Hyperlipidemia'],ARRAY[]::text[],'Heart healthy','full_code',true,NULL,'standard',false,false,'ltc_insurance',425000,0,425000,'2025-01-20','Synthetic full_name 0d63deaac7','Wife','202-555-0117','Synthetic full_name 0d63deaac7','Wife','202-555-0117','06:00','22:00')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO staff (id, user_id, facility_id, organization_id, first_name, last_name, phone, email, staff_role, employment_status, hire_date, hourly_rate, is_full_time) VALUES
  ('50000003-0000-0000-0000-000000000001',NULL,'00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001','Synthetic first_name 47612b3175','Synthetic last_name 98c14afe72','202-555-0118','synthetic-5accad90b5@example.invalid','administrator','active','2015-02-01',3450,true),
  ('50000003-0000-0000-0000-000000000002',NULL,'00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001','Synthetic first_name cdf30c6b34','Synthetic last_name 9dceb0fe98','202-555-0123','synthetic-5350204ad2@example.invalid','lpn','active','2018-05-01',2750,true),
  ('50000003-0000-0000-0000-000000000003',NULL,'00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001','Synthetic first_name 4ca6f6d5a5','Synthetic last_name f98407019f','202-555-0170','synthetic-6831ed83ed@example.invalid','cna','active','2020-09-10',1650,true),
  ('50000003-0000-0000-0000-000000000004',NULL,'00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001','Synthetic first_name f73137d930','Synthetic last_name bd6e50d182','202-555-0169','synthetic-035fcf9190@example.invalid','cna','active','2023-01-15',1650,true)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO activities (id, facility_id, organization_id, name, description, default_day_of_week, default_start_time, default_duration_minutes, facilitator, is_recurring) VALUES
  ('ac000003-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001','Garden Club','Raised-bed gardening',ARRAY[4],'09:30',40,'Synthetic full_name 022a2c6ba3',true),
  ('ac000003-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001','Devotions','Non-denominational reading circle',ARRAY[0],'10:30',30,'Synthetic full_name ad2a346d33',true)
ON CONFLICT (id) DO NOTHING;

INSERT INTO activity_sessions (id, activity_id, facility_id, organization_id, session_date, start_time, end_time, facilitator_name, cancelled) VALUES
  ('a5000003-0000-0000-0000-000000000001','ac000003-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001',CURRENT_DATE,(CURRENT_DATE + '09:30'::time)::timestamptz,(CURRENT_DATE + '10:10'::time)::timestamptz,'Synthetic full_name 022a2c6ba3',false),
  ('a5000003-0000-0000-0000-000000000002','ac000003-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001',CURRENT_DATE + 2,(CURRENT_DATE + 2 + '10:30'::time)::timestamptz,(CURRENT_DATE + 2 + '11:00'::time)::timestamptz,'Synthetic full_name ad2a346d33',false)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO resident_payers (id, resident_id, facility_id, organization_id, payer_type, is_primary, payer_name, effective_date) VALUES
  ('b4000003-0000-0000-0000-000000000001','c0000003-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001','private_pay',true,'Synthetic full_name ddc3aa9403 Jr','2024-01-10'),
...
INSERT INTO payments (id, resident_id, facility_id, organization_id, entity_id, invoice_id, payment_date, amount, payment_method, reference_number, payer_name) VALUES
  ('b7000003-0000-0000-0000-000000000001','c0000003-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001','00000000-0000-0000-0001-000000000003','b5000003-0000-0000-0000-000000000001','2026-03-08',460000,'check','CHK-HW-1','Synthetic full_name ddc3aa9403 Jr')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO staffing_ratio_snapshots (id, facility_id, organization_id, shift, residents_present, staff_on_duty, ratio, required_ratio, is_compliant, staff_detail) VALUES
  ('bb000003-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000003','00000000-0000-0000-0000-000000000001','day',4,2,2.0,5.00,true,'[{"name":"Synthetic full_name ad2a346d33","role":"cna"},{"name":"Synthetic full_name 187e669dea","role":"cna"}]')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO residents (id, facility_id, organization_id, bed_id, first_name, last_name, preferred_name, date_of_birth, gender, ssn_last_four, status, acuity_level, admission_date, primary_physician_name, primary_physician_phone, primary_diagnosis, diagnosis_list, allergy_list, diet_order, code_status, ambulatory, assistive_device, fall_risk_level, elopement_risk, wandering_risk, primary_payer, monthly_base_rate, monthly_care_surcharge, monthly_total_rate, rate_effective_date, responsible_party_name, responsible_party_relationship, responsible_party_phone, emergency_contact_1_name, emergency_contact_1_relationship, emergency_contact_1_phone, preferred_wake_time, preferred_bed_time) VALUES
  ('c0000004-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000004','00000000-0000-0000-0000-000000000001','b0000004-0000-0000-0000-000000000101','Synthetic first_name 0c086cdc77','Synthetic last_name c4d1968057',NULL,'1940-12-03','female','1100','active','level_2','2024-04-01','Dr. Hayes','202-555-0120','Osteoarthritis',ARRAY['OA','HTN'],ARRAY[]::text[],'Regular','full_code',true,'Cane','moderate',false,false,'private_pay',425000,35000,460000,'2024-04-01','Paul Ingram','Son','202-555-0162','Paul Ingram','Son','202-555-0162','07:00','21:00'),
  ('c0000004-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000004','00000000-0000-0000-0000-000000000001','b0000004-0000-0000-0000-000000000102','Synthetic last_name c512ca0c5c','Synthetic last_name b2808c947e',NULL,'1945-08-19','male','2211','active','level_1','2023-10-12','Dr. Rivera','202-555-0123','GERD',ARRAY['GERD'],ARRAY[]::text[],'Regular','full_code',true,NULL,'standard',false,false,'va_aid_attendance',425000,0,425000,'2023-10-12','Synthetic full_name c48dfa6104','Daughter','202-555-0162','Synthetic full_name c48dfa6104','Daughter','202-555-0162','06:45','22:00'),
  ('c0000004-0000-0000-0000-000000000003','00000000-0000-0000-0002-000000000004','00000000-0000-0000-0000-000000000001','b0000004-0000-0000-0000-000000000103','Synthetic first_name c5420b4378','Synthetic last_name 931f22c928','Synthetic first_name c5420b4378','1936-01-28','female','3322','active','level_3','2024-08-15','Dr. Hayes','202-555-0120','Parkinson''s disease',ARRAY['Parkinson''s disease'],ARRAY['Morphine'],'Mechanical soft','full_code',false,'Wheelchair','high',true,false,'private_pay',425000,75000,500000,'2024-08-15','Sofia Gomez','Daughter','202-555-0169','Sofia Gomez','Daughter','202-555-0169','07:30','19:30'),
  ('c0000004-0000-0000-0000-000000000004','00000000-0000-0000-0002-000000000004','00000000-0000-0000-0000-000000000001','b0000004-0000-0000-0000-000000000104','Synthetic first_name f148389d08','Synthetic last_name f4f4df4551',NULL,'1949-05-07','male','4433','active','level_1','2025-03-01','Dr. Crawford','202-555-0161','Hearing loss',ARRAY['Hearing loss'],ARRAY[]::text[],'Regular','full_code',true,NULL,'standard',false,false,'private_pay',425000,0,425000,'2025-03-01','Synthetic full_name e4230b7ce1','Wife','202-555-0144','Synthetic full_name e4230b7ce1','Wife','202-555-0144','06:30','21:30')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO staff (id, user_id, facility_id, organization_id, first_name, last_name, phone, email, staff_role, employment_status, hire_date, hourly_rate, is_full_time) VALUES
  ('50000004-0000-0000-0000-000000000001',NULL,'00000000-0000-0000-0002-000000000004','00000000-0000-0000-0000-000000000001','Synthetic first_name 42570c45c8','Synthetic last_name 2b10814e2f','202-555-0144','synthetic-3afa9ee923@example.invalid','administrator','active','2013-06-01',3500,true),
  ('50000004-0000-0000-0000-000000000002',NULL,'00000000-0000-0000-0002-000000000004','00000000-0000-0000-0000-000000000001','Synthetic first_name e811eb7830','Synthetic last_name c87f42bd45','202-555-0188','synthetic-8ffc509428@example.invalid','lpn','active','2017-03-01',2800,true),
  ('50000004-0000-0000-0000-000000000003',NULL,'00000000-0000-0000-0002-000000000004','00000000-0000-0000-0000-000000000001','Synthetic first_name 99bde068af','Synthetic last_name a70a16a8bc','202-555-0138','synthetic-a37b5c4807@example.invalid','cna','active','2021-07-01',1650,true),
  ('50000004-0000-0000-0000-000000000004',NULL,'00000000-0000-0000-0002-000000000004','00000000-0000-0000-0000-000000000001','Synthetic first_name 962cd22346','Synthetic last_name 0e66633604','202-555-0195','synthetic-9f41149dc7@example.invalid','cna','active','2022-09-01',1650,true)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO activities (id, facility_id, organization_id, name, description, default_day_of_week, default_start_time, default_duration_minutes, facilitator, is_recurring) VALUES
  ('ac000004-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000004','00000000-0000-0000-0000-000000000001','Cornhole','Outdoor lawn games',ARRAY[5,6],'16:00',45,'Synthetic full_name 30fb2dd413',true),
  ('ac000004-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000004','00000000-0000-0000-0000-000000000001','Book Club','Chapter discussion',ARRAY[2],'15:00',60,'Synthetic full_name c8942a9376',true)
ON CONFLICT (id) DO NOTHING;

INSERT INTO activity_sessions (id, activity_id, facility_id, organization_id, session_date, start_time, end_time, facilitator_name, cancelled) VALUES
  ('a5000004-0000-0000-0000-000000000001','ac000004-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000004','00000000-0000-0000-0000-000000000001',CURRENT_DATE,(CURRENT_DATE + '16:00'::time)::timestamptz,(CURRENT_DATE + '16:45'::time)::timestamptz,'Synthetic full_name 30fb2dd413',false),
  ('a5000004-0000-0000-0000-000000000002','ac000004-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000004','00000000-0000-0000-0000-000000000001',CURRENT_DATE + 3,(CURRENT_DATE + 3 + '15:00'::time)::timestamptz,(CURRENT_DATE + 3 + '16:00'::time)::timestamptz,'Synthetic full_name c8942a9376',false)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO staffing_ratio_snapshots (id, facility_id, organization_id, shift, residents_present, staff_on_duty, ratio, required_ratio, is_compliant, staff_detail) VALUES
  ('bb000004-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000004','00000000-0000-0000-0000-000000000001','day',4,2,2.0,5.00,true,'[{"name":"Synthetic full_name 30fb2dd413","role":"cna"},{"name":"Synthetic full_name f6e11ebbac","role":"cna"}]')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO residents (id, facility_id, organization_id, bed_id, first_name, last_name, preferred_name, date_of_birth, gender, ssn_last_four, status, acuity_level, admission_date, primary_physician_name, primary_physician_phone, primary_diagnosis, diagnosis_list, allergy_list, diet_order, code_status, ambulatory, assistive_device, fall_risk_level, elopement_risk, wandering_risk, primary_payer, monthly_base_rate, monthly_care_surcharge, monthly_total_rate, rate_effective_date, responsible_party_name, responsible_party_relationship, responsible_party_phone, emergency_contact_1_name, emergency_contact_1_relationship, emergency_contact_1_phone, preferred_wake_time, preferred_bed_time) VALUES
  ('c0000005-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000005','00000000-0000-0000-0000-000000000001','b0000005-0000-0000-0000-000000000101','Synthetic first_name 879d13f425','Synthetic last_name 428e626f22',NULL,'1943-10-11','female','5500','active','level_2','2024-05-01','Dr. Hayes','202-555-0120','Hypothyroidism',ARRAY['Hypothyroidism'],ARRAY[]::text[],'Regular','full_code',true,NULL,'moderate',false,false,'ltc_insurance',425000,35000,460000,'2024-05-01','Synthetic full_name f7f9428020 Jr','Son','202-555-0185','Synthetic full_name f7f9428020 Jr','Son','202-555-0185','07:00','21:00'),
  ('c0000005-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000005','00000000-0000-0000-0000-000000000001','b0000005-0000-0000-0000-000000000102','Synthetic first_name cb9b5a0f4a','Synthetic last_name d3a61c6844',NULL,'1947-02-02','male','6611','active','level_1','2023-11-20','Dr. Rivera','202-555-0123','BPH',ARRAY['BPH'],ARRAY[]::text[],'Regular','full_code',true,NULL,'standard',false,false,'private_pay',425000,0,425000,'2023-11-20','Synthetic full_name 124cc867d4','Wife','202-555-0122','Synthetic full_name 124cc867d4','Wife','202-555-0122','06:30','22:00'),
  ('c0000005-0000-0000-0000-000000000003','00000000-0000-0000-0002-000000000005','00000000-0000-0000-0000-000000000001','b0000005-0000-0000-0000-000000000103','Synthetic first_name 1906bc7c80','Synthetic last_name 2ffeb435f5',NULL,'1939-07-14','female','7722','active','level_3','2024-09-10','Dr. Hayes','202-555-0120','Alzheimer''s disease',ARRAY['Alzheimer''s disease'],ARRAY['Sulfa'],'Mechanical soft','full_code',true,'Walker','high',false,true,'medicaid_oss',425000,75000,500000,'2024-09-10','Synthetic full_name 73a61f9fbb','Son','202-555-0177','Synthetic full_name 73a61f9fbb','Son','202-555-0177','08:00','19:00'),
  ('c0000005-0000-0000-0000-000000000004','00000000-0000-0000-0002-000000000005','00000000-0000-0000-0000-000000000001','b0000005-0000-0000-0000-000000000104','Synthetic first_name 6232101675','Synthetic last_name 04fa179b2c',NULL,'1952-11-30','male','8833','active','level_1','2025-02-15','Dr. Crawford','202-555-0161','Depression',ARRAY['Depression'],ARRAY[]::text[],'Regular','full_code',true,NULL,'standard',false,false,'private_pay',425000,0,425000,'2025-02-15','Synthetic full_name fab6ad9253','Sister','202-555-0167','Synthetic full_name fab6ad9253','Sister','202-555-0167','07:30','21:30')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO staff (id, user_id, facility_id, organization_id, first_name, last_name, phone, email, staff_role, employment_status, hire_date, hourly_rate, is_full_time) VALUES
  ('50000005-0000-0000-0000-000000000001',NULL,'00000000-0000-0000-0002-000000000005','00000000-0000-0000-0000-000000000001','Synthetic first_name b8d8a9b672','Synthetic last_name c512ca0c5c','202-555-0101','synthetic-362618e9ba@example.invalid','administrator','active','2014-08-01',3450,true),
  ('50000005-0000-0000-0000-000000000002',NULL,'00000000-0000-0000-0002-000000000005','00000000-0000-0000-0000-000000000001','Synthetic first_name 1b6d6d8b06','Synthetic last_name cd0e182ad3','202-555-0196','synthetic-7f95b2baa1@example.invalid','lpn','active','2019-01-01',2700,true),
  ('50000005-0000-0000-0000-000000000003',NULL,'00000000-0000-0000-0002-000000000005','00000000-0000-0000-0000-000000000001','Synthetic first_name 18ae79fac1','Synthetic last_name a746222f09','202-555-0148','synthetic-84cbfa884b@example.invalid','cna','active','2020-04-01',1650,true),
  ('50000005-0000-0000-0000-000000000004',NULL,'00000000-0000-0000-0002-000000000005','00000000-0000-0000-0000-000000000001','Synthetic first_name e0e2087b3e','Synthetic first_name fb0f00141e','202-555-0183','synthetic-7634a53449@example.invalid','cna','active','2023-08-01',1650,true)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO activities (id, facility_id, organization_id, name, description, default_day_of_week, default_start_time, default_duration_minutes, facilitator, is_recurring) VALUES
  ('ac000005-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000005','00000000-0000-0000-0000-000000000001','Chair Yoga','Seated stretching',ARRAY[1,3,5],'10:30',35,'Synthetic full_name c4f3201dae',true),
  ('ac000005-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000005','00000000-0000-0000-0000-000000000001','Ice Cream Social','Monthly treat cart',ARRAY[6],'15:00',45,'Synthetic full_name bf44bf3b34',true)
ON CONFLICT (id) DO NOTHING;

INSERT INTO activity_sessions (id, activity_id, facility_id, organization_id, session_date, start_time, end_time, facilitator_name, cancelled) VALUES
  ('a5000005-0000-0000-0000-000000000001','ac000005-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000005','00000000-0000-0000-0000-000000000001',CURRENT_DATE,(CURRENT_DATE + '10:30'::time)::timestamptz,(CURRENT_DATE + '11:05'::time)::timestamptz,'Synthetic full_name c4f3201dae',false),
  ('a5000005-0000-0000-0000-000000000002','ac000005-0000-0000-0000-000000000002','00000000-0000-0000-0002-000000000005','00000000-0000-0000-0000-000000000001',CURRENT_DATE + 4,(CURRENT_DATE + 4 + '15:00'::time)::timestamptz,(CURRENT_DATE + 4 + '15:45'::time)::timestamptz,'Synthetic full_name bf44bf3b34',false)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO staffing_ratio_snapshots (id, facility_id, organization_id, shift, residents_present, staff_on_duty, ratio, required_ratio, is_compliant, staff_detail) VALUES
  ('bb000005-0000-0000-0000-000000000001','00000000-0000-0000-0002-000000000005','00000000-0000-0000-0000-000000000001','day',4,2,2.0,5.00,true,'[{"name":"Synthetic full_name c4f3201dae","role":"cna"},{"name":"Synthetic full_name 1befb597c4","role":"cna"}]')
ON CONFLICT (id) DO NOTHING;
