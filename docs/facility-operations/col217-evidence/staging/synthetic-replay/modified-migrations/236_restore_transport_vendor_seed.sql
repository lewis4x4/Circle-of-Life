...
BEGIN
  ...
  IF v_vendor_id IS NULL THEN
    ...
    VALUES (v_org_id, 'Alternative Transport', 'other', 'active', 'Synthetic primary_contact_name 745cc9f7c7', NULL, NULL)
  ...
  IF v_vendor_id IS NULL THEN
    INSERT INTO vendors (organization_id, name, category, status, primary_contact_name, primary_contact_phone, created_by)
    VALUES (v_org_id, 'Jackson Transport', 'other', 'active', 'Synthetic primary_contact_name 96d9632f36', NULL, NULL)
    RETURNING id INTO v_vendor_id;
  END IF;
  ...
  IF v_vendor_id IS NULL THEN
    INSERT INTO vendors (organization_id, name, category, status, primary_contact_name, primary_contact_phone, created_by)
    VALUES (v_org_id, 'Parrish Medivan', 'other', 'active', 'Synthetic primary_contact_name 95726315a1', NULL, NULL)
    RETURNING id INTO v_vendor_id;
  END IF;
  ...
  IF v_vendor_id IS NULL THEN
    INSERT INTO vendors (organization_id, name, category, status, primary_contact_name, primary_contact_phone, created_by)
    VALUES (v_org_id, 'Peeler Transport', 'other', 'active', 'Synthetic primary_contact_name f4a095dfba', NULL, NULL)
    RETURNING id INTO v_vendor_id;
  END IF;
  ...
  IF v_vendor_id IS NULL THEN
    INSERT INTO vendors (organization_id, name, category, status, primary_contact_name, primary_contact_phone, created_by)
    VALUES (v_org_id, 'D''s Transport', 'other', 'active', 'Synthetic primary_contact_name e6293a1622', NULL, NULL)
    RETURNING id INTO v_vendor_id;
  END IF;
  ...
  IF v_vendor_id IS NULL THEN
    INSERT INTO vendors (organization_id, name, category, status, primary_contact_name, primary_contact_phone, created_by)
    VALUES (v_org_id, 'Lafayette County', 'other', 'active', 'Synthetic primary_contact_name 605705a2c3', NULL, NULL)
    RETURNING id INTO v_vendor_id;
  END IF;
