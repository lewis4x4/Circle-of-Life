...
BEGIN
  ...
  INSERT INTO facility_building_profiles (
    ...
    3,
    'Synthetic contact e766ad16b3', 'Synthetic contact ed37b089b2', '202-555-0163',
    'Synthetic contact 0f857a749c', '202-555-0112'
  ...
  INSERT INTO facility_building_profiles (
    ...
    true, 'propane', 'Ring Power / ACF Generator Service',
    3,
    'Synthetic contact e766ad16b3', 'Synthetic contact 89506c4838', '202-555-0163',
    'Synthetic contact 0f857a749c', '202-555-0112'
  ) ON CONFLICT (facility_id) DO NOTHING;
  ...
  INSERT INTO facility_building_profiles (
    ...
    true, 'propane', 'Ring Power / ACF Generator Service',
    3,
    'Synthetic contact c8f8f08b5b', 'Synthetic contact 7092fa5755', '202-555-0137',
    'Synthetic contact 0f857a749c', '202-555-0112'
  ) ON CONFLICT (facility_id) DO NOTHING;
  ...
  INSERT INTO facility_building_profiles (
    ...
    true, 'propane', 'Ring Power / ACF Generator Service',
    3,
    'Synthetic contact f1e61e4389', 'Synthetic contact 672cdfd984', '202-555-0170',
    'Synthetic contact 17947bfeea', '202-555-0153'
  ) ON CONFLICT (facility_id) DO NOTHING;
  ...
  INSERT INTO facility_building_profiles (
    ...
    true, 'propane', 'Ring Power / ACF Generator Service',
    3,
    'Synthetic contact f1e61e4389', 'Synthetic contact 1b2d7db81f', '202-555-0170',
    'Synthetic contact 17947bfeea', '202-555-0153'
  ) ON CONFLICT (facility_id) DO NOTHING;
  ...
  INSERT INTO facility_emergency_contacts (facility_id, organization_id, contact_category, contact_name, phone_primary, sort_order) VALUES
    (v_oakridge_id, v_org_id, 'county_emergency_mgmt', 'Synthetic contact dae7f51a62', '202-555-0108', 1),
    (v_oakridge_id, v_org_id, 'law_enforcement', 'Synthetic contact 6138b7b3ed', '202-555-0158', 2),
    (v_oakridge_id, v_org_id, 'county_health_dept', 'Synthetic contact 1b9339f3c9', '202-555-0191', 3),
    (v_oakridge_id, v_org_id, 'city_government', 'Synthetic contact 4305665a6a', '202-555-0199', 4),
    (v_oakridge_id, v_org_id, 'county_bldg_zoning', 'Synthetic contact d8ae85aa5b', '202-555-0189', 5),
    (v_oakridge_id, v_org_id, 'utility_electric', 'Synthetic contact e766ad16b3', '202-555-0163', 6),
    (v_oakridge_id, v_org_id, 'gas_provider', 'Synthetic contact 0f857a749c', '202-555-0112', 7),
    (v_oakridge_id, v_org_id, 'fire_alarm_monitoring', 'Synthetic contact 5da83b4516', '202-555-0183', 8),
    (v_oakridge_id, v_org_id, 'hvac_emergency', 'Synthetic contact 45dd55aaac', '202-555-0161', 9),
    (v_oakridge_id, v_org_id, 'generator_service', 'Synthetic contact a8ce7a6790', '202-555-0120', 10),
    (v_oakridge_id, v_org_id, 'hospital', 'Synthetic contact 33955cba02', '202-555-0126', 11);

  -- Homewood Lodge ALF
  INSERT INTO facility_emergency_contacts (facility_id, organization_id, contact_category, contact_name, phone_primary, sort_order) VALUES
    (v_homewood_id, v_org_id, 'county_emergency_mgmt', 'Synthetic contact 5c9ccf31cf', '202-555-0108', 1),
    (v_homewood_id, v_org_id, 'law_enforcement', 'Synthetic contact 6138b7b3ed', '202-555-0158', 2),
    (v_homewood_id, v_org_id, 'county_health_dept', 'Synthetic contact 1b9339f3c9', '202-555-0191', 3),
    (v_homewood_id, v_org_id, 'city_government', 'Synthetic contact 4305665a6a', '202-555-0199', 4),
    (v_homewood_id, v_org_id, 'county_bldg_zoning', 'Synthetic contact d8ae85aa5b', '202-555-0189', 5),
    (v_homewood_id, v_org_id, 'utility_electric', 'Synthetic contact e766ad16b3', '202-555-0163', 6),
    (v_homewood_id, v_org_id, 'gas_provider', 'Synthetic contact 0f857a749c', '202-555-0112', 7),
    (v_homewood_id, v_org_id, 'fire_alarm_monitoring', 'Synthetic contact 5da83b4516', '202-555-0183', 8),
    (v_homewood_id, v_org_id, 'hvac_emergency', 'Synthetic contact 45dd55aaac', '202-555-0161', 9),
    (v_homewood_id, v_org_id, 'generator_service', 'Synthetic contact a8ce7a6790', '202-555-0120', 10),
    (v_homewood_id, v_org_id, 'hospital', 'Synthetic contact 33955cba02', '202-555-0126', 11);

  -- Rising Oaks ALF
  INSERT INTO facility_emergency_contacts (facility_id, organization_id, contact_category, contact_name, phone_primary, sort_order) VALUES
    (v_rising_oaks_id, v_org_id, 'county_emergency_mgmt', 'Synthetic contact 3cc371d656', '202-555-0107', 1),
    (v_rising_oaks_id, v_org_id, 'law_enforcement', 'Synthetic contact 07aea67b3d', '202-555-0183', 2),
    (v_rising_oaks_id, v_org_id, 'county_health_dept', 'Synthetic contact c03a63077a', '202-555-0162', 3),
    (v_rising_oaks_id, v_org_id, 'city_government', 'Synthetic contact 9c17fd4df2', '202-555-0103', 4),
    (v_rising_oaks_id, v_org_id, 'county_bldg_zoning', 'Synthetic contact 621bc385c8', '202-555-0184', 5),
    (v_rising_oaks_id, v_org_id, 'utility_electric', 'Synthetic contact c8f8f08b5b', '202-555-0137', 6),
    (v_rising_oaks_id, v_org_id, 'gas_provider', 'Synthetic contact 0f857a749c', '202-555-0112', 7),
    (v_rising_oaks_id, v_org_id, 'fire_alarm_monitoring', 'Synthetic contact 5da83b4516', '202-555-0183', 8),
    (v_rising_oaks_id, v_org_id, 'hvac_emergency', 'Synthetic contact 3f818dc606', '202-555-0198', 9),
    (v_rising_oaks_id, v_org_id, 'generator_service', 'Synthetic contact a8ce7a6790', '202-555-0120', 10),
    (v_rising_oaks_id, v_org_id, 'hospital', 'Synthetic contact 33955cba02', '202-555-0126', 11);

  -- Plantation on Summers
  INSERT INTO facility_emergency_contacts (facility_id, organization_id, contact_category, contact_name, phone_primary, sort_order) VALUES
    (v_plantation_id, v_org_id, 'county_emergency_mgmt', 'Synthetic contact 5d1641ba57', '202-555-0119', 1),
    (v_plantation_id, v_org_id, 'law_enforcement', 'Synthetic contact a9ce73339a', '202-555-0158', 2),
    (v_plantation_id, v_org_id, 'county_health_dept', 'Synthetic contact b8b647ba4e', '202-555-0178', 3),
    (v_plantation_id, v_org_id, 'city_government', 'Synthetic contact b065d858b3', '202-555-0103', 4),
    (v_plantation_id, v_org_id, 'county_bldg_zoning', 'Synthetic contact 19de9af17c', '202-555-0100', 5),
    (v_plantation_id, v_org_id, 'utility_electric', 'Synthetic contact f1e61e4389', '202-555-0170', 6),
    (v_plantation_id, v_org_id, 'gas_provider', 'Synthetic contact 17947bfeea', '202-555-0153', 7),
    (v_plantation_id, v_org_id, 'fire_alarm_monitoring', 'Synthetic contact 5da83b4516', '202-555-0183', 8),
    (v_plantation_id, v_org_id, 'hvac_emergency', 'Synthetic contact 3f818dc606', '202-555-0198', 9),
    (v_plantation_id, v_org_id, 'generator_service', 'Synthetic contact a8ce7a6790', '202-555-0120', 10),
    (v_plantation_id, v_org_id, 'hospital', 'Synthetic contact 33955cba02', '202-555-0126', 11);

  -- Grande Cypress ALF
  INSERT INTO facility_emergency_contacts (facility_id, organization_id, contact_category, contact_name, phone_primary, sort_order) VALUES
    (v_grande_cypress_id, v_org_id, 'county_emergency_mgmt', 'Synthetic contact 5d1641ba57', '202-555-0119', 1),
    (v_grande_cypress_id, v_org_id, 'law_enforcement', 'Synthetic contact a013af37c1', '202-555-0164', 2),
    (v_grande_cypress_id, v_org_id, 'fire_department', 'Synthetic contact bf80007aad', '202-555-0184', 3),
    (v_grande_cypress_id, v_org_id, 'county_health_dept', 'Synthetic contact b8b647ba4e', '202-555-0178', 4),
    (v_grande_cypress_id, v_org_id, 'city_government', 'Synthetic contact b065d858b3', '202-555-0103', 5),
    (v_grande_cypress_id, v_org_id, 'county_bldg_zoning', 'Synthetic contact 19de9af17c', '202-555-0100', 6),
    (v_grande_cypress_id, v_org_id, 'utility_electric', 'Synthetic contact f1e61e4389', '202-555-0170', 7),
    (v_grande_cypress_id, v_org_id, 'gas_provider', 'Synthetic contact 17947bfeea', '202-555-0153', 8),
    (v_grande_cypress_id, v_org_id, 'fire_alarm_monitoring', 'Synthetic contact 5da83b4516', '202-555-0183', 9),
    (v_grande_cypress_id, v_org_id, 'hvac_emergency', 'Synthetic contact 3f818dc606', '202-555-0198', 10),
    (v_grande_cypress_id, v_org_id, 'generator_service', 'Synthetic contact a8ce7a6790', '202-555-0120', 11),
    (v_grande_cypress_id, v_org_id, 'hospital', 'Synthetic contact 33955cba02', '202-555-0126', 12);
  ...
  FROM facilities f
  CROSS JOIN (VALUES
    ('electric_maintenance', 'Synthetic contact b0c00f825c', '202-555-0157', '202-555-0117', 20),
    ('plumbing_emergency', 'Synthetic contact 5adecb92d1', '202-555-0137', NULL, 21),
    ('plumbing_emergency', 'Synthetic contact 65ff5d09e6', '202-555-0155', NULL, 22),
    ('plumbing_emergency', 'Synthetic contact 0daf6dd5c3', '202-555-0110', NULL, 23),
    ('roofing', 'Synthetic contact 5a6bf840e9', '202-555-0121', '202-555-0133', 24),
    ('other', 'Synthetic contact 727c95f637', '202-555-0170', NULL, 25),
    ('other', 'Synthetic contact ccb0707025', '202-555-0169', NULL, 26),
    ('generator_service', 'Synthetic contact ef07027f68', '202-555-0172', NULL, 27)
  ...
  FROM facilities f
  CROSS JOIN (VALUES
    ('Synthetic contact 90fb019e41', '202-555-0197', 30),
    ('Synthetic contact 3fd79c4019', '202-555-0139', 31),
    ('Synthetic contact 0ab49e0ded', '202-555-0152', 32),
    ('Synthetic contact 58d3d0f917', '202-555-0199', 33),
    ('Synthetic contact 85fffc0525', '202-555-0174', 34)
  ...
  SELECT f.id, v_org_id, 'transport', 'Synthetic contact 4e6af9e157', '202-555-0110', 'Lafayette County facilities ONLY', 35
  FROM facilities f
