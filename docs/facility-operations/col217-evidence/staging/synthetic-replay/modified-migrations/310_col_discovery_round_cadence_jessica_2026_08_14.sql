...
COMMENT ON FUNCTION public.apply_plantation_wing_observation_plan(uuid) IS
  'Blocked until Synthetic full_name 9a4451a0ee supplies Plantation cadence. Migration 219 wing defaults are not operator defaults.';
...
COMMENT ON FUNCTION public.apply_col_discovery_round_observation_plan(uuid) IS
  'Applies Synthetic full_name 9a4451a0ee COL discovery-round cadence per resident. Plantation is blocked until owner supplies times.';
