...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    'synthetic-6845290729@example.invalid', pw, ts,
    '{"provider":"email","providers":["email"],"app_role":"med_tech"}',
    '{"full_name":"Synthetic full_name 49b2a857c6","email_verified":true}',
  ...
  VALUES (
    ...
    '{"sub":"a0000000-0000-0000-0000-000000000012","email":"synthetic-6845290729@example.invalid","email_verified":true,"phone_verified":false}',
...
INSERT INTO user_profiles (id, organization_id, email, full_name, phone, app_role) VALUES
  ('a0000000-0000-0000-0000-000000000012', '00000000-0000-0000-0000-000000000001',
   'synthetic-6845290729@example.invalid', 'Synthetic full_name 49b2a857c6', '202-555-0170', 'med_tech')
ON CONFLICT (id) DO UPDATE SET
