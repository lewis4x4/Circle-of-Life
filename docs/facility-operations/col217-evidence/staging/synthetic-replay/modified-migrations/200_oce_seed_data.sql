...
BEGIN
  ...
  IF EXISTS (
    ...
    WHERE conname = 'fa_service_vendor_fk'
  ) THEN
...
-- Daily AM Rounds (7am-3pm)
  ('00000000-0000-0000-0000-000000000001', NULL, 'Daily AM Rounds',
...
-- Daily PM Rounds (3pm-11pm)
  ('00000000-0000-0000-0000-000000000001', NULL, 'Daily PM Rounds',
...
-- Daily Night Rounds (11pm-7am)
  ('00000000-0000-0000-0000-000000000001', NULL, 'Daily Night Rounds',
   ...
   'normal', 15),
-- Daily Kitchen Check
  ('00000000-0000-0000-0000-000000000001', NULL, 'Daily Kitchen Inspection',
   'Check refrigerator temps, food safety logs, prep area cleanliness, stock levels.',
   'daily_rounds', 'daily', 'day', 'dietary_manager',
   '[]'::jsonb, 'normal', 10),
-- Daily Laundry Check
  ('00000000-0000-0000-0000-000000000001', NULL, 'Daily Linens Check',
...
-- Weekly Fire Drill Check
  ('00000000-0000-0000-0000-000000000001', NULL, 'Weekly Fire Drill Log Review',
...
-- Weekly Medication Review
  ('00000000-0000-0000-0000-000000000001', NULL, 'Weekly Medication Reconciliation',
...
-- Weekly Staff Meeting Minutes
  ('00000000-0000-0000-0000-000000000001', NULL, 'Weekly Staff Meeting',
...
-- Weekly Activity Schedule Review
  ('00000000-0000-0000-0000-000000000001', NULL, 'Weekly Activity Schedule',
...
-- Monthly Resident Council Notes
  ('00000000-0000-0000-0000-000000000001', NULL, 'Monthly Resident Council',
...
-- Monthly Fire Safety Inspection
  ('00000000-0000-0000-0000-000000000001', NULL, 'Monthly Fire Safety Check',
...
-- Monthly Medication Storage Audit
  ('00000000-0000-0000-0000-000000000001', NULL, 'Monthly Medication Storage Review',
...
-- Quarterly Disaster Preparedness Review
  ('00000000-0000-0000-0000-000000000001', NULL, 'Quarterly Disaster Preparedness',
...
-- Quarterly Staff Competency Review
  ('00000000-0000-0000-0000-000000000001', NULL, 'Quarterly Staff Competency Assessment',
...
-- Yearly Physical Plant Inspection
  ('00000000-0000-0000-0000-000000000001', NULL, 'Annual Building Inspection',
...
-- Yearly Policy Review
  ('00000000-0000-0000-0000-000000000001', NULL, 'Annual Policy Handbook Review',
...
-- AHCA Survey Preparation Audit
  ('00000000-0000-0000-0000-000000000001', NULL, 'AHCA Survey Readiness Audit',
...
-- Monthly Incident Review Audit
  ('00000000-0000-0000-0000-000000000001', NULL, 'Monthly Incident Trend Analysis',
...
INSERT INTO operation_task_templates (
  organization_id, facility_id, name, description, category, cadence_type,
  day_of_month, assignee_role, escalation_ladder,
  priority, survey_readiness_impact, estimated_minutes
) VALUES
-- Monthly Collection Call Cycle
  ('00000000-0000-0000-0000-000000000001', NULL, 'Monthly Collection Outreach',
   'Contact all accounts >30 days past due, document payment promises, update collection log.',
   'collections', 'monthly', 15, 'collections_manager',
...
-- Weekly New Hire File Review
  ('00000000-0000-0000-0000-000000000001', NULL, 'Weekly New Hire File Check',
   'Verify all new hires from past week have complete HR files: background check, licensure, certifications.',
   'employee_file', 'weekly', 5, 'hr_manager',
   '[{"role": "coo", "sla_minutes": 72, "channel": "in_app", "enabled": true}]'::jsonb,
...
-- Quarterly License Verification
  ('00000000-0000-0000-0000-000000000001', NULL, 'Quarterly Staff License Audit',
   'Verify all staff licenses current, no disciplinary actions pending, renewals on track.',
   'employee_file', 'quarterly', 1, 'hr_manager',
...
-- Monthly MHSP Review
  ('00000000-0000-0000-0000-000000000001', NULL, 'Monthly Mental Health Support Plan Review',
...
COMMENT ON TABLE operation_task_templates IS
  ...
  Defines every operational task template across all cadences (daily/weekly/monthly/quarterly/yearly).
   ...
   never user IDs. Synthetic full_name 58a07cd50b = COO, templates use assignee_role='coo'.
   $$;
