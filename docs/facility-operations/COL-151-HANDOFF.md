...
Source commit `ceb9811324bce3a19804ba962bca7521342d2bd4` is pushed in PR #494. This checkpoint proves local/native engineering delivery and synthetic authenticated HTTP against hosted staging Auth/DB/Storage. Main/production release remains pending. Guarded `col151-evidence/apply-staging.py` applies only reviewed364/365 to verified staging, with DDL and ledger in one transaction. The independently reviewed hosted proof runner executed successfully:1,001 unique occurrences, reconciled correction/evidence totals, unchanged original CSV after a later correction, fresh snapshot with the third receipt, and anonymous/other-requester/other-site/revoked-cookie denial. Staging364/365 was atomically applied and read back. Four synthetic actors were banned; active profiles/grants are zero. Immutable history and finalized evidence remain retained. The local app was stopped after proof. Browser UI and real staff operating acceptance were not performed.
