...
| PH1-OA04 | **PH1-P06** — Pro plan, **BAA** before PHI, **PITR** enabled | PARTIAL | Brian Lewis / agent | 2026-05-12 | Supabase Pro plan and BAA owner-confirmed. `supabase backups list --project-ref manfqmasfqppukpobpld -o json` confirmed completed physical backups through 2026-05-12, but reports `pitr_enabled: false`; PITR is not currently enabled. See [COL-GO-LIVE-READINESS-CHECKLIST.md](./COL-GO-LIVE-READINESS-CHECKLIST.md). |
