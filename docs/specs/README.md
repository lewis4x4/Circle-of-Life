...
**Module 24 — Executive Intelligence Layer v1** (🟩 Core admin UI shipped — cron `exec_kpi_snapshots` backlog)
...
Routes live: `/admin/executive` (command center), `/admin/executive/alerts`, `/admin/executive/reports`, `/admin/executive/settings`, `/admin/executive/entity`, `/admin/executive/entity/[id]`, `/admin/executive/facility/[id]`. Backlog: cron-filled `exec_kpi_snapshots` (optional PDF export on reports page in Enhanced).
