...
**Repo migrations:** **`001`–`194`** — verify with `npm run migrations:check` and `npm run migrations:verify:pg` before release.
...
**Next free migration number:** **`195`** — use for all new DDL after updating this README and the relevant spec.
