...
| F4-3-petty-cash-resident-trust | 2026-06-13 | `test-results/agent-gates/2026-06-14T01-48-31-316Z-F4-3-petty-cash-resident-trust.json` (PASS, `--ui`) | _next commit on main_ | pass — migration `295` petty cash + per-resident trust ledgers (Rep Payee/SSA-787), money in cents, immutable insert-only ledgers (no UPDATE/DELETE), finance-role RLS + audit |
