...
| F4-4-survey-readiness-binder | 2026-06-14 | `test-results/agent-gates/2026-06-14T02-38-34-593Z-F4-4-survey-readiness-binder.json` (PASS, `--ui`) | `_next commit on main_` | pass — migration `303` curated AHCA readiness checklist layered over live evidence (facility documents, in-services, drills due, last survey); admin/office RLS, audit + soft-delete |
