...
| F3-6-shift-handoff-board | 2026-06-13 | `test-results/agent-gates/2026-06-14T02-22-16-766Z-F3-6-shift-handoff-board.json` (PASS, `--ui`) | _next commit on main_ | pass — migration `301` facility shift handoff board (post + acknowledge, resident-linkable, priority sort); facility-staff RLS, audit + soft-delete |
