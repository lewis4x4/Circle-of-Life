...
| F4-2-front-desk-kit | 2026-06-13 | `test-results/agent-gates/2026-06-14T01-42-50-736Z-F4-2-front-desk-kit.json` (PASS, `--ui`) | _next commit on main_ | pass — migration `294` visitor log (with IC health screening) + package/mail custody log + resident-linked family call log; staff record/read, audit + soft delete |
