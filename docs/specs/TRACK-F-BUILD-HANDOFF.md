...
| F3-7-comments-mentions | 2026-06-13 | `test-results/agent-gates/2026-06-14T02-27-31-472Z-F3-7-comments-mentions.json` (PASS, `--ui`) | _next commit on main_ | pass — migration `302` polymorphic comments + @mentions; RLS inherits subject visibility (private-page comments stay private via RLS-filtered subqueries); audit + soft-delete |
