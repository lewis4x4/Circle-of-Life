...
| F3-4-team-spaces | 2026-06-13 | `test-results/agent-gates/2026-06-14T02-12-05-854Z-F3-4-team-spaces.json` (PASS, `--ui`) | _next commit on main_ | pass — migration `299` team spaces + membership + page sharing (visibility=team); membership-based RLS read, single-editor preserved, audit + soft-delete |
