...
| F3-5-personal-kanban | 2026-06-13 | `test-results/agent-gates/2026-06-14T02-17-31-416Z-F3-5-personal-kanban.json` (PASS, `--ui`) | _next commit on main_ | pass — migration `300` private kanban cards (owner-only RLS) + read-only OCE task mirror (OCE stays system of record); audit + soft-delete |
