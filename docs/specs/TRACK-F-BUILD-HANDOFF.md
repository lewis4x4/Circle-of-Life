...
| F1-4-facility-master-calendar | 2026-06-12 | `test-results/agent-gates/2026-06-12T21-20-04-106Z-F1-4-facility-master-calendar.json` (PASS, `--ui`) | `f32e9d49` | pass — read-only month calendar layering six existing RLS-scoped dated sources (transport, meetings, in-services, drills, doc expirations, surveys) + `.ics` export; no DDL |
