...
| F2-4-contact-directory-on-call | 2026-06-13 | `test-results/agent-gates/2026-06-14T01-37-39-840Z-F2-4-contact-directory-on-call.json` (PASS, `--ui`) | _next commit on main_ | pass — migration `293` per-facility rolodex (pharmacy/hospice/physician/AHCA/MCO) + after-hours on-call schedule; all staff read, office roles manage; audit + soft delete |
