...
| F3-3-publish-to-group | 2026-06-13 | `test-results/agent-gates/2026-06-14T02-05-52-607Z-F3-3-publish-to-group.json` (PASS, `--ui`) | _next commit on main_ | pass — migration `298` F0-4 governed publish (draft→submit→facility_admin/DON review→KB document); immutable snapshot, reviewer-role RLS, audit + soft-delete |
