...
| F3-1-personal-notes-pages | 2026-06-13 | `test-results/agent-gates/2026-06-14T01-54-35-026Z-F3-1-personal-notes-pages.json` (PASS, `--ui`) | _next commit on main_ | pass — migration `296` first private-content table ships F0-1 break-glass (typed reason, RLS-enforced live grant, audited) + F0-2 audit/soft-delete + F0-3 ownership-transfer primitive; pages, version history, single-editor lock |
