...
| **Full acceptance** | **PENDING** until [PHASE1-ACCEPTANCE-CHECKLIST.md](./PHASE1-ACCEPTANCE-CHECKLIST.md) rows are checked with **real auth** on the **target environment**, or explicit **waivers** for known gaps (e.g. RCA persistence). |
