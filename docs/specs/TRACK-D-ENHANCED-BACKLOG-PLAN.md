...
**~~Recommended next segment — D69~~** **DONE (2026-04-10)** — Module **13:** **`/admin/payroll/[id]`** — **hours split CSV** (REG/OT/total) — [TRACK-D-PHASE6-PASS.md](./TRACK-D-PHASE6-PASS.md).

**~~Recommended next segment — D70~~** **DONE (2026-04-10)** — Module **22:** **`/admin/referrals`** — **pipeline status filter** + **leads CSV respects filter** — [TRACK-D-PHASE6-PASS.md](./TRACK-D-PHASE6-PASS.md).

**~~Recommended next segment — D71~~** **DONE (2026-04-10)** — Module **22:** **`/admin/referrals/hl7-inbound`** — **queue search** (client-side) — [TRACK-D-PHASE6-PASS.md](./TRACK-D-PHASE6-PASS.md).
...
**~~Recommended next segment — D74~~** **DONE (2026-04-10)** — Module **13:** **`/admin/payroll`** — **hub batch search** (client-side) — [TRACK-D-PHASE6-PASS.md](./TRACK-D-PHASE6-PASS.md).

**~~Recommended next segment — D75~~** **DONE (2026-04-10)** — Module **23:** **`/admin/reputation`** — **replies CSV status scope** — [TRACK-D-PHASE6-PASS.md](./TRACK-D-PHASE6-PASS.md).

**~~Recommended next segment — D76~~** **DONE (2026-04-10)** — Module **15:** **`/admin/transportation`** — **status filter + transport CSV scope** — [TRACK-D-PHASE6-PASS.md](./TRACK-D-PHASE6-PASS.md).
...
**~~Recommended next segment — D81~~** **DONE (2026-04-10)** — Module **11:** **`/admin/certifications`** — **certifications CSV matches hub filters** — [TRACK-D-PHASE6-PASS.md](./TRACK-D-PHASE6-PASS.md).

**~~Recommended next segment — D82~~** **DONE (2026-04-10)** — Module **11:** **`/admin/schedules`** — **schedule weeks CSV matches hub filters** — [TRACK-D-PHASE6-PASS.md](./TRACK-D-PHASE6-PASS.md).

**Recommended next segment — D83+ (owner priority):** **14** full Edge/cron cross-check after clinical rules sign-off; other §1 deferrals — one bounded slice at a time.
