...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`288` (`288_apply_invoice_payment.sql`) — **next free migration: `289`** |
...
3. New DDL takes the next free migration number (currently `289`) and updates this file.
