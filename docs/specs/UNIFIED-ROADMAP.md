...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`305` (`305_drive_cutover.sql`) — **next free migration: `306`** |
...
3. New DDL takes the next free migration number (currently `306`) and updates this file.
