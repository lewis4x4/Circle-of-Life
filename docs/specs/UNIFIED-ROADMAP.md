...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`290` (`290_office_letters.sql`) — **next free migration: `291`** |
...
3. New DDL takes the next free migration number (currently `291`) and updates this file.
