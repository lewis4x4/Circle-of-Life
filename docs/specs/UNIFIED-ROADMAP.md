...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`295` (`295_office_cash_trust_ledgers.sql`) — **next free migration: `296`** |
...
3. New DDL takes the next free migration number (currently `296`) and updates this file.
