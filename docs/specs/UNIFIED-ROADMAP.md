...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`298` (`298_workspace_publish_requests.sql`) — **next free migration: `299`** |
...
3. New DDL takes the next free migration number (currently `299`) and updates this file.
