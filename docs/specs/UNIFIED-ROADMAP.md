...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`291` (`291_office_internal_forms.sql`) — **next free migration: `292`** |
...
3. New DDL takes the next free migration number (currently `292`) and updates this file.
