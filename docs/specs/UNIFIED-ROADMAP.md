...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`301` (`301_shift_handoff_notes.sql`) — **next free migration: `302`** |
...
3. New DDL takes the next free migration number (currently `302`) and updates this file.
