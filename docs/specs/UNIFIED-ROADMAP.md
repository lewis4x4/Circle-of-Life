...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`289` (`289_office_meetings.sql`) — **next free migration: `290`** |
...
3. New DDL takes the next free migration number (currently `290`) and updates this file.
