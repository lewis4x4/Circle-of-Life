...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`303` (`303_survey_binder_items.sql`) — **next free migration: `304`** |
...
3. New DDL takes the next free migration number (currently `304`) and updates this file.
