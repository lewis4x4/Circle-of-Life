...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`296` (`296_workspace_pages.sql`) — **next free migration: `297`** |
...
3. New DDL takes the next free migration number (currently `297`) and updates this file.
