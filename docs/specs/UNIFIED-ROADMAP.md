...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`292` (`292_office_document_acknowledgments.sql`) — **next free migration: `293`** |
...
3. New DDL takes the next free migration number (currently `293`) and updates this file.
