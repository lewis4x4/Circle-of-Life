...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`299` (`299_workspace_team_spaces.sql`) — **next free migration: `300`** |
...
3. New DDL takes the next free migration number (currently `300`) and updates this file.
