...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`304` (`304_drive_import.sql`) — **next free migration: `305`** |
...
3. New DDL takes the next free migration number (currently `305`) and updates this file.
