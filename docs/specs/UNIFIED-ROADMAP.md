...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`300` (`300_workspace_cards.sql`) — **next free migration: `301`** |
...
3. New DDL takes the next free migration number (currently `301`) and updates this file.
