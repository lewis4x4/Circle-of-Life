...
| Fact | Value |
|------|-------|
| Repo migrations | `001`–`297` (`297_workspace_files.sql`) — **next free migration: `298`** |
...
3. New DDL takes the next free migration number (currently `298`) and updates this file.
