...
**Next targeted UI file:** `src/app/(admin)/staff/page.tsx` data integration pass (replace mock roster with Supabase-backed query adapter while preserving shared list states), then `src/app/(admin)/billing/page.tsx`.
