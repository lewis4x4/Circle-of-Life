...
**Next targeted UI file:** `src/app/(admin)/incidents/page.tsx` data integration pass (replace mock queue with Supabase-backed query adapter while preserving shared list states).
