...
Migration numbers for this build start at 478; 476 is retired (COL-668, applied to Haven HFO Staging only) and 477 is held for PR #729. See ALLOWED_GAPS in scripts/check-migration-order.mjs.
