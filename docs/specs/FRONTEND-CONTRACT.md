...
- `/admin/referrals/hl7-inbound` (Phase 6 Module 22 — `22-referral-crm.md`; **Copy raw** — D65; **status filter** — D67; **CSV respects filter** — D68)
...
- `/admin/payroll/new`
- `/admin/payroll/[id]` (import mileage + **approved time records** into lines — Track D17 + D58; **full + flat + vendor handoff CSV** — D18 + D59 + D64)
- `/admin/staffing`
- `/admin/billing/rates`
